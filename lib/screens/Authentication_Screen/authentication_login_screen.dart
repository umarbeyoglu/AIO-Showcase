...
import 'package:Welpie/screens/Authentication_Screen/authentication_register_screen.dart';
import '../../colors.dart';
...
cursorColor: colordtmaintwo,
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: emailst,labelStyle:  TextStyle(  color: colordtmaintwo,),
                                hintText: eyemailst,hintStyle: TextStyle(  color: colordtmaintwo,),
  ...
  style: TextStyle(color: colordtmaintwo),
                              decoration: InputDecoration(
                                ...
                                labelText: passwordst,labelStyle:  TextStyle(  color: colordtmaintwo,),
                                hintText: eypasswordst,hintStyle: TextStyle(  color: colordtmaintwo,),
                                // If  you are using latest version of flutter then lable text and hint text shown like this
                                // if you r using flutter less then 1.20.* then maybe this is not working properly
                                floatingLabelBehavior: FloatingLabelBehavior.auto,
                              ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                         child: Text(loginst, style:TextStyle(fontSize:MediaQuery.of(context).size.height*0.025,),),
                          onPressed:  (){
                            setState(() {
    ...
    //        if (response3.statusCode == 200) {
                           ...
                           //   if(signincheck == 2)  loginattempt = true;
                            ...
                            if(signincheck == 2) signIn(_emailController.text,_passwordController.text) ;
                             signincheck = 0;
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => RegisterScreen(issubprofile: false,user:User())
                              ),
                            );
                          },
                        ),
