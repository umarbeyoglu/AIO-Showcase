...
class FirstTimePhoneScreen extends StatefulWidget {
  final User user;
  const FirstTimePhoneScreen({Key key, this.user,}) : super(key: key);
  @override
  FirstTimePhoneScreenState createState() => FirstTimePhoneScreenState(user:user);
}

class FirstTimePhoneScreenState extends State<FirstTimePhoneScreen> with SingleTickerProviderStateMixin{
  final User user;
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimeAboutScreen(user: mainuser)));
    }
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          controller: _phonenumber,keyboardType: TextInputType.number,
                          maxLength: 60,
                  ...
                  Padding(
                    ...
                    child: Text(firsttimephoneexpst,
                      style: TextStyle(
                        color:colordtmaintwo,
                        fontSize: MediaQuery.of(context).size.height*0.025,
                        fontWeight: FontWeight.bold,
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: (){
                          print(globaltoken);
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimeAboutScreen(user: user)));
                        },
