...
class FirstTimeImageScreen extends StatefulWidget {
  final User user;
  const FirstTimeImageScreen({Key key, this.user,}) : super(key: key);
  @override
  FirstTimeImageScreenState createState() => FirstTimeImageScreenState(user:user);
}

class FirstTimeImageScreenState extends State<FirstTimeImageScreen> with SingleTickerProviderStateMixin{
  final User user;
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimePublicProfileScreen(user: mainuser)));
    }
  }
            ...
            Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  image == null ? Container(height: 0,width: 0,) : SizedBox(
                ...
                SizedBox(height:20),
                  ...
                  Padding(
                    ...
                    child: Text(user.profile_type == 'B' ? firsttimeimagebsexpst: firsttimeimageexpst,
                      style: TextStyle(
                        color:colordtmaintwo,
                        fontSize: MediaQuery.of(context).size.height*0.025,
                        fontWeight: FontWeight.bold,
                      ...
                      CreateUserPP(String userid,File image) async {
                        ...
                        try {
                          ...
                          else if(imagename !=  'empty')
                          {
                            ...
                            Response response2 = await Dio().patch("$SERVER_IP/api/ownuser/$userid/", data: formData2,options: Options(headers: {"Authorization" : "Token ${globaltoken}"} ));
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: (){
                          print(globaltoken);
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimeLocationScreen(user: user)));
                        },
