...
class FirstTimeHotelScreen extends StatefulWidget {
  final User user;
  const FirstTimeHotelScreen({
    Key key,
    this.user,
  }) : super(key: key);
  @override
  FirstTimeHotelScreenState createState() =>
      FirstTimeHotelScreenState(user: user);
}

class FirstTimeHotelScreenState extends State<FirstTimeHotelScreen>
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FirstTimeWifiScreen(user: mainuser)));
    }
  }
