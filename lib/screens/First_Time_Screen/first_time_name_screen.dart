import 'package:untitled/screens/First_Time_Screen/first_time_phone_number_screen.dart';
...
class FirstTimeNameScreen extends StatefulWidget {
  final User user;
  const FirstTimeNameScreen({Key key, this.user,}) : super(key: key);
  @override
  FirstTimeNameScreenState createState() => FirstTimeNameScreenState(user:user);
}

class FirstTimeNameScreenState extends State<FirstTimeNameScreen> with SingleTickerProviderStateMixin{
  final User user;
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimePhoneScreen(user: mainuser)));
    }
  }
              ...
              child: Column(
               ...
               SizedBox(
                  ...
                  Padding(
                    ...
                    child: Text(user.profile_type == 'B' ? firsttimenamebsexpst: firsttimenameexpst,
                      style: TextStyle(
                        color:colordtmaintwo,
                        fontSize: MediaQuery.of(context).size.height*0.025,
                        fontWeight: FontWeight.bold,
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimePhoneScreen(user: user)));
                        },
