...
import 'first_time_image_screen.dart';
...
class FirstTimePublicProfileScreen extends StatefulWidget {
  final User user;
  const FirstTimePublicProfileScreen({Key key, this.user,}) : super(key: key);
  @override
  FirstTimePublicProfileScreenState createState() => FirstTimePublicProfileScreenState(user:user);
}

class FirstTimePublicProfileScreenState extends State<FirstTimePublicProfileScreen> with SingleTickerProviderStateMixin{
  final User user;
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimeLocationScreen(user: mainuser)));
    }
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(firsttimepublicprofileexpst,
                      style: TextStyle(
                        color:colordtmaintwo,
                        fontSize: MediaQuery.of(context).size.height*0.025,
                        fontWeight: FontWeight.bold,
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => FirstTimeTagsScreen(user: user)));
                        },
