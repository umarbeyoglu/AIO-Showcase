...
class FirstTimeWifiScreen extends StatefulWidget {
  final User user;
  const FirstTimeWifiScreen({
    Key key,
    this.user,
  }) : super(key: key);
  @override
  FirstTimeWifiScreenState createState() =>
      FirstTimeWifiScreenState(user: user);
}

class FirstTimeWifiScreenState extends State<FirstTimeWifiScreen>
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FirstTimePriceRangeScreen(user: mainuser)));
    }
  }
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  FirstTimePriceRangeScreen(user: user)));
                        },
                      ),
                      SizedBox(
