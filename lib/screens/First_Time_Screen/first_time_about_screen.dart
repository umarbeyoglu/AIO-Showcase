...
class FirstTimeAboutScreen extends StatefulWidget {
  final User user;
  const FirstTimeAboutScreen({
    Key key,
    this.user,
  }) : super(key: key);
  @override
  FirstTimeAboutScreenState createState() =>
      FirstTimeAboutScreenState(user: user);
}

class FirstTimeAboutScreenState extends State<FirstTimeAboutScreen>
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FirstTimeImageScreen(user: mainuser)));
    }
  }
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            FirstTimeImageScreen(user: user)));
                  },
                ),
