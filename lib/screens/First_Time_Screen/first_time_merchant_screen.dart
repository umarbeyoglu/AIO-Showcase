...
class FirstTimeMerchantScreen extends StatefulWidget {
  final User user;
  const FirstTimeMerchantScreen({
    Key key,
    this.user,
  }) : super(key: key);
  @override
  FirstTimeMerchantScreenState createState() =>
      FirstTimeMerchantScreenState(user: user);
}

class FirstTimeMerchantScreenState extends State<FirstTimeMerchantScreen>
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FirstTimeHotelScreen(user: mainuser)));
    }
  }
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  FirstTimeHotelScreen(user: user)));
                        },
                      ),
                      SizedBox(
