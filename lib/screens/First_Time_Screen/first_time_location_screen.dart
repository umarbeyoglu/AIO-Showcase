...
class FirstTimeLocationScreen extends StatefulWidget {
  final User user;
  const FirstTimeLocationScreen({
    Key key,
    this.user,
  }) : super(key: key);
  @override
  FirstTimeLocationScreenState createState() =>
      FirstTimeLocationScreenState(user: user);
}

class FirstTimeLocationScreenState extends State<FirstTimeLocationScreen>
  ...
  Future<User> refreshProfile() async {
    ...
    if (response.statusCode == 200) {
      ...
      return Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => FirstTimeTagsScreen(user: mainuser)));
    }
  }
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  FirstTimePublicProfileScreen(user: user)));
                        },
                      ),
                      SizedBox(
