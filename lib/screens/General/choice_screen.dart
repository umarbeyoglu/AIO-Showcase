...
class CalendarEventEditChoiceScreen extends StatefulWidget {
  ...
  const CalendarEventEditChoiceScreen({Key key,this.product }) : super(key: key);
  @override
  CalendarEventEditChoiceScreenState createState() => CalendarEventEditChoiceScreenState(product:product);
}

class CalendarEventEditChoiceScreenState extends State<CalendarEventEditChoiceScreen> {
  final Article product;
          ...
          for (final item in choices)
            Column(
              children: [
                ...
                for (final item2 in item.choices)Column(
                  children: [
                    Row(
                      children: [
                    ...
                    Row(
                      children: [
                        SizedBox(width:10),   Text('Delete Choice',style:TextStyle(
                            fontWeight: FontWeight.w400,
                  ...
                  children: [
                    ...
                    Text('Add Item',style:TextStyle(
                      ...
                      onPressed: () {
                        setState(() {
                          ChoiceModel model =
                          ChoiceModel(item: TextEditingController(text: ""),price:TextEditingController(text: ""));
                ...
                Text('End of Category ${item.title.text}',style:TextStyle(
                    fontWeight: FontWeight.w400,
                    color: colordtmaintwo),),
            ...
            Column(
              children: [
                ...
                Text('${item.category}',style:TextStyle(
                    ...
                    color: colordtmaintwo),),
                Divider(color: colordtmaintwo,),
                for (final item2 in product.choices)Column(
                  children: [
                    Row(
                      children: [
                        SizedBox(width:10),      Text('Item ${item2.item}',style:TextStyle(
                            fontWeight: FontWeight.w400,
                            color: colordtmaintwo),),
                      ],
                    ),
                ...
                CheckboxListTile(
                  title:  Text(allchooseablest,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                ...
                Text('End of Category ${item.category}',style:TextStyle(
                    fontWeight: FontWeight.w400,
                    color: colordtmaintwo),),
                Divider(color: colordtmaintwo,thickness: 3,),
                InkWell(child: Text('Finish Edits'),
                onTap:(){
                  for(int i=0;i<choices.length;i++){
                    CreateUserProductChoiceCategory(product.id, choices[i]);
                  }
                  for(int i=0;i<product.choicecategories.length;i++){
                    if(product.choicecategories[i].ischanged){
                      EditUserProductChoiceCategory(product.choicecategories[i], product.choicecategories[i].val);
                    }
                  }
...
class CalendarEventChoiceScreen extends StatefulWidget {
  ...
  const CalendarEventChoiceScreen({Key key,this.user,this.product,this.visiteduser,this.category }) : super(key: key);
  @override
  CalendarEventChoiceScreenState createState() => CalendarEventChoiceScreenState(user: user,product:product,category: category,visiteduser:visiteduser);
}
...
class CalendarEventChoiceScreenState extends State<CalendarEventChoiceScreen> {
  ...
  final Article product;
  final String category;
  CalendarEventChoiceScreenState({Key key,this.user,this.product,this.visiteduser,this.category});
          ...
          for (final item in product.choicecategories)
            Column(
              children: [
                ...
                Row(
                  children: [
                    SizedBox(width:20), Text('${item.category}',style: TextStyle(color:colordtmainthree,fontWeight:  FontWeight.bold)),
                  ],
                ...
                for (final item2 in product.choices)
                  if(item.category == item2.category)
                    CheckboxListTile(
                      title:  Text('${item2.item} ', style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.bold)),
                      subtitle:Text('${item2.price.toString()} Dollars', style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                      value: item2.ischosen,checkColor: Colors.white,selectedTileColor: Colors.white,
                      onChanged: (bool value) {
                        setState(() { item2.ischosen = value;
                ...
                InkWell(
                  ...
                  onTap:(){
                    CreateCartItem(product, user.id,product.author, product.caption, product.id, 'Article', 1, product.price,double.parse(product.deliveryfee));
                  },
                ),
              ],),
        ],),);}}
...
class CreateChoiceScreen extends StatefulWidget {
  ...
  const CreateChoiceScreen({Key key, }) : super(key: key);
  @override
          ...
          for (final item in choices)
            Column(
              children: [
                ...
                CheckboxListTile(
                  title:  Text(allchooseablest,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: item.allchooseable, onChanged: (bool value) {
                  setState(() {
...
class UserProductEditChoiceScreen extends StatefulWidget {
  ...
  @override
  UserProductEditChoiceScreenState createState() => UserProductEditChoiceScreenState(product:product);
}

class UserProductEditChoiceScreenState extends State<UserProductEditChoiceScreen> {
  final Article product;
...
class UserProductEditDetailCategoryScreen extends StatefulWidget {
  final Article product;
  const UserProductEditDetailCategoryScreen({Key key,this.product }) : super(key: key);
  @override
  UserProductEditDetailCategoryScreenState createState() => UserProductEditDetailCategoryScreenState(product:product);
}

class UserProductEditDetailCategoryScreenState extends State<UserProductEditDetailCategoryScreen> {
  final Article product;
                ...
                for (final item2 in item.detailspecs)
                  Column(
                    children: [
                      Row(
                        children: [
                          SizedBox(width:10),      Text('Item ${item2.category}',style:TextStyle(
                              fontWeight: FontWeight.w400,
                              color: colordtmaintwo),),
                        ],
                      ),
                ...
                for (final item2 in product.detailspecs)
                  ...
                  Column(
                    children: [
                      Row(
                        children: [
                          SizedBox(width:10),      Text('Item ${item2.spec}',style:TextStyle(
                              fontWeight: FontWeight.w400,
                              color: colordtmaintwo),),
                        ],
                      ),
...
class UserProductChoiceScreen extends StatefulWidget {
  ...
  final Article product;
  final String category;
  const UserProductChoiceScreen({Key key,this.user,this.product,this.visiteduser,this.category }) : super(key: key);
  @override
  UserProductChoiceScreenState createState() => UserProductChoiceScreenState(user: user,product:product,category: category,visiteduser:visiteduser);
}
...
class UserProductChoiceScreenState extends State<UserProductChoiceScreen> {
  ...
  final Article product;
  final String category;
  UserProductChoiceScreenState({Key key,this.user,this.product,this.visiteduser,this.category});
          ...
          for (final item in product.choicecategories)
            Column(
              children: [
                ...
                Row(
                  children: [
                    SizedBox(width:20), Text('${item.category}',style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.bold)),
                  ],
                ), //Choice Categories Here
