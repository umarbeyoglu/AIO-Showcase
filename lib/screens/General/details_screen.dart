  ...
  initdetailspecs() {
    ...
    for (int i = 0; i < article.detailcategories.length; i++) {
      for (int i2 = 0; i2 < article.detailspecs.length; i2++) {
        if (article.detailcategories[i].category ==
            article.detailspecs[i2].category) {
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.03),
                                    if (article.detailincludeds.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                          horizontal: MediaQuery.of(context)
                                                  .size
                                    ...
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.03),
                                    if (article.detailrules.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                          horizontal: MediaQuery.of(context)
                                                  .size
                                    ...
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.03),
                                    if (article.detailamenities.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                          horizontal: MediaQuery.of(context)
                                                  .size
                                    ...
                                    SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.03),
                                    if (article.travellocations.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                          horizontal: MediaQuery.of(context)
                                                  .size
                                    ...
                                    Tags(
                                      ...
                                      itemBuilder: (i) {
                                        return ItemTags(
                                          ...
                                          index: i,
                                          title:
                                              '@${usertags[i].username.toString()}',
                                          color: Color(0xFFEEEEEE),
                                          activeColor: Color(0xFFEEEEEE),
                                          onPressed: (item) {
                                            NavgListPublic(user,
                                                usertags[i].profile, context);
                                          },
                                          textColor: colordtmaintwo,
                                          textActiveColor: colordtmaintwo,
                                          textStyle: TextStyle(
                                  ...
                                  children: <Widget>[
                                    ...
                                    for (final item in userproduct.checkboxes)
                                      CheckboxListTile(
                                        ...
                                        value:
                                            item.initializecontent(false, true),
