...
class _SearchScreenState extends State<SearchScreen> {
  ...
  @override
  void initState() {
    fetchPostsfuture = SearchUsersNew2(page, globaltxt, globaltxt.split(','),
        tagsearch, searchbasedonlocation);
  ...
  Future _loadmoreusers() async {
    List<User> postsinit = [];
    postsinit = await SearchUsersNew2(page, globaltxt, globaltxt.split(','),
        tagsearch, searchbasedonlocation);
    setState(() {
      for (final item2 in postsinit) _usersForDisplay.add(item2);
      isLoading = false;
      return;
    });
  }
  ...
  bool crowdlevel(String crowdlevel) {
    ...
    if (searchcrowdness == 'low') {
      if (crowdlevel == 'low' || crowdlevel == 'idle') {
        return true;
      }
    }
  ...
  Future _loadmoreposts() async {
    ...
    postsinit = await SearchArticlesNew2(
        page,
        globaltxt,
        globaltxt.split(','),
        tagsearch,
        ...
        user);
    setState(() {
      for (final item2 in postsinit) _postsForDisplay.add(item2);
      isLoading = false;
      return;
    });
  }
              ...
              itemBuilder: (context, index) {
                return index == 0
                    ...
                    : searching == false
                        ...
                        : _listItemUserProductCategory(index - 1);
              },
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_textfield) {
                        setState(() {
                          ...
                          List<String> advicetags =
                              _textfield.toLowerCase().split(',');
                          advices =
                              TagSuggestion(advicetags.last.toLowerCase());
                        });
                        _textfield == ''
                            ? setState(() {
                                searching = false;
                  ...
                  title: Form(
                    child: TextFormField(
                      ...
                      onChanged: (_textfield) {
                        ...
                        //      if(tagsearch == false){_groupsForDisplay = _groups.where((group) {if(group.name.toLowerCase().contains(_textfield.toLowerCase())){group.name.toLowerCase().contains(_textfield.toLowerCase());};if(doSearch(_textfield.toLowerCase().split(','),group.searchgrouptags(),group.origgrouptags(group),true)){doSearch(_textfield.toLowerCase().split(','),group.searchgrouptags(),group.origgrouptags(group),true);};return false;}).toList();}});}
                        ...
                        } else if (chosensearchtype == foodsst &&
                            searchcategorytype == false) {
                          setState(() {
                            _posts = [];
                            _postsForDisplay = [];
                            SearchArticlesNew2(
                          ...
                          setState(() {
                            ...
                            SearchUserProductCategoriesNew2(
                                    page, _textfield.toLowerCase())
                                .then((value) {
                              setState(() {
                                _userproductcategories.addAll(value);
                                _userproductcategoriesForDisplay =
                                    _userproductcategories;
                              });
                            });
                  ...
                  title: Form(
                    child: TextFormField(
                      ...
                      onChanged: (_textfield) {
                        ...
                        } else if (chosensearchtype == groceryshoppingst &&
                            searchcategorytype == false) {
                          setState(() {
                            _posts = [];
                            _postsForDisplay = [];
  ...
  List<String> TagSuggestion(String tag) {
    ...
    if (tag == laptopsize13inch) {
      return laptopbrands;
    }
    if (tag == laptopsize15inch) {
      return laptopbrands;
    }
    if (tag == laptopsize17inch) {
      return laptopbrands;
    } else
      return [];
  }
  ...
  init() {
    if (locationcountrygl != '') {
      searchbasedonlocation = true;
    }
    if (locationcountrygl == '') {
      searchbasedonlocation = false;
    }
  }
              ...
              itemBuilder: (i) {
                return ItemTags(
                  ...
                  onPressed: (tags) {
                    setState(() {
                      _textfield.text =
                          '${_textfield.text},${advices[i].toString()}';
                    });
                  },
                  title: advices[i].toString(),
                  color: Color(0xFFEEEEEE),
  ...
  _listItemUserProductCategory(index) {
    bool cond(User owner) {
      ...
      if (chosensearchtype == groceryshoppingst &&
          owner.business_type.substring(0, 15) == 'GroceryShopping') {
        return true;
      }
      if (chosensearchtype == groceryshoppingst &&
          owner.business_type.substring(0, 15) == 'GroceryShopping') {
      ...
      if (chosensearchtype == foodsst &&
          owner.business_type.substring(0, 10) == 'Restaurant' &&
          restauranttypesearch == 'A') {
        return true;
      }
                          ...
                          children: <Widget>[
                            InkWell(
                              child: Image(
                                fit: BoxFit.cover,
                                image: NetworkImage(
                                    _userproductcategoriesForDisplay[index]
                                                .image
                                                ?.isEmpty ??
                                            true
                                        ? 'https://www.theladders.com/wp-content/uploads/shopping_190514.jpg'
                                        : _userproductcategoriesForDisplay[
                                                index]
                                            .image),
                              ),
                              onTap: () {
                              //  Navigator.push(context, MaterialPageRoute(builder: (_) => UserProductScreen(user: user, category: _userproductcategoriesForDisplay[index].id,)),);
                              },
                              onLongPress: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (_) => DeleteThingScreen(
                                            category: 'UPC',
                                            id: _userproductcategoriesForDisplay[
                                                    index]
                                                .id,
                                          )),
                                ).then((value) {
                      ...
                      children: [
                        ListTile(
                          title: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(_usersForDisplay[
                                            index]
                                        .image ==
                                    null
                          ...
                          onTap: () {
                            isuserfollowed(user.id, _usersForDisplay[index].id)
                              ..then((res) {
                                if (user.shouldshowuserinfo(
                                        _usersForDisplay[index], res) ==
                                    'public') {
                                  FetchPublicUserNav(user,
                                      _usersForDisplay[index].id, context);
                                }
                                ;
                                if (user.shouldshowuserinfo(
                                        _usersForDisplay[index], res) ==
                                    'followed') {
                                  FetchFollowedUserNav(user,
                                      _usersForDisplay[index].id, context);
                                }
                                ;
                                if (user.shouldshowuserinfo(
                        ...
                        isuserfollowed(user.id, _usersForDisplay[index].id)
                          ..then((res) {
                            if (user.shouldshowuserinfo(
                                ...
                                'public') {
                              FetchPublicUserNav(
                                  user, _usersForDisplay[index].id, context);
                            }
                            ;
                            if (user.shouldshowuserinfo(
                                    _usersForDisplay[index], res) ==
  ...
  _listItemBusiness(index) {
    ...
    if (_usersForDisplay[index].business_type == null)
      return Container(
        height: 0,
        width: 0,
      );
    if (_usersForDisplay[index].business_type == '')
      return Container(
        height: 0,
        width: 0,
      );
    ...
    if (chosensearchtype == businessst &&
        ...
        _usersForDisplay[index].business_type.substring(0, 15) ==
            'GroceryShopping')
      return Container(
        margin:
        ...
        child: Column(
          children: [
            ListTile(
              title: CircleAvatar(
                radius: MediaQuery.of(context).size.height * 0.045,
                backgroundImage: NetworkImage(_usersForDisplay[index].image ==
                        null
                    ? 'https://st2.depositphotos.com/4111759/12123/v/600/depositphotos_121233262-stock-illustration-male-default-placeholder-avatar-profile.jpg'
                    : _usersForDisplay[index].image),
              ),
              ...
              onTap: () {
                isuserfollowed(user.id, _usersForDisplay[index].id)
                  ..then((res) {
                    if (user.shouldshowuserinfo(_usersForDisplay[index], res) ==
                        'public') {
                      FetchPublicUserNav(
                          user, _usersForDisplay[index].id, context);
                    }
    ...
    if (chosensearchtype == businessst &&
        ...
        _usersForDisplay[index].business_type.substring(0, 10) ==
            'Restaurant' &&
        restauranttypesearch ==
            _usersForDisplay[index].business_type.substring(11, 12))
      return Container(
        margin:
            EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.03),
        padding: EdgeInsets.symmetric(
  ...
  _listItemReservation(index) {
    bool cond(User owner) {
      if (crowdlevel(owner.intensity) == false) {
        return false;
      }
      if (searchhotelclass &&
          owner.hotelclass < int.parse(hotelclasssearchgl)) {
        return false;
      }
      if (searchbasedonlocation) {
        if (checklocationvalidity(
                _postsForDisplay[index].locationcountry,
                _postsForDisplay[index].locationstate,
                _postsForDisplay[index].locationcity) ==
            false) {
          return false;
        }
      }
      if (searchbedbath &&
          (_postsForDisplay[index].bedrooms < int.parse(bedroomsearchgl) ||
              _postsForDisplay[index].bathrooms <
                  int.parse(bathroomsearchgl))) {
        return false;
      }
      if (searchadultkid &&
          (_postsForDisplay[index].adults < int.parse(adultsearchgl) ||
              _postsForDisplay[index].kids < int.parse(kidsearchgl))) {
        return false;
      }
      if (checklocationvalidity(
              _postsForDisplay[index].locationcountry,
      ...
      if (priceactivated) {
        if (_postsForDisplay[index].price > pricehigh) {
          return false;
        }
        if (_postsForDisplay[index].price < pricelow) {
          return false;
        }
      }
      if (searchbydate) {
        if (searchdate != _postsForDisplay[index].date) {
          return false;
        }
      }
      return true;
  ...
  _listItemUserService(index) {
    bool cond(User owner) {
      if (crowdlevel(_usersForDisplay[index].intensity) == false) {
        return false;
      }
      if (searchbasedonlocation) {
        if (checklocationvalidity(
  ...
  _listItemPost(index) {
    return ArticleWidgetScreen(
        user: user, post: _postsForDisplay[index], ischosing: false);
  }

  _listItemjobPost(index) {
    return _postsForDisplay[index].isjobposting == true
        ? ArticleWidgetScreen(
            user: user, post: _postsForDisplay[index], ischosing: false)
        : Container(
            height: 0,
...
class SearchFilterScreen extends StatefulWidget {
  ...
  @override
  SearchFilterScreenState createState() =>
      SearchFilterScreenState(user: user, key: key);
}
  ...
  Widget chosensearchtypecategory() {
    if (chosensearchtype == foodsst || chosensearchtype == groceryshoppingst) {
      return CheckboxListTile(
        title: Text(choosebycataloguest,
            style:
                TextStyle(color: colordtmaintwo, fontWeight: FontWeight.bold)),
          ...
          Container(
            child: Column(
              children: [
                ...
                CheckboxListTile(
                  title: Text(businessst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypebusiness,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = businessst;
                      chosensearchtype2 = '';
                ...
                CheckboxListTile(
                  title: Text(groceryshopst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypegroceryshop,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype2 = groceryshopst;
                      chosensearchtype = businessst;
                ...
                CheckboxListTile(
                  title: Text(restaurantst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtyperestaurant,
                  onChanged: (bool value) {
                    setState(() {
                      searchtypereservation = !value;
                      chosensearchtype2 = restaurantst;
                ...
                CheckboxListTile(
                  ...
                  onChanged: (bool value) {
                    setState(() {
                      searchtypeuser = !value;
                      chosensearchtype = userproductsst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtyperestaurant = !value;
                      searchtypereservation = !value;
                ...
                CheckboxListTile(
                  title: Text(postsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypepost,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = postst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtyperestaurant = !value;
                      searchtypereservation = !value;
                ...
                CheckboxListTile(
                  title: Text(groceryshoppingst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypegrocery,
                  onChanged: (bool value) {
                    setState(() {
                      searchtypeuser = !value;
                      chosensearchtype = groceryshoppingst;
                      chosensearchtype2 = '';
                      searchtypereservation = !value;
                      searchtypeuser = !value;
                      searchtyperestaurant = !value;
                ...
                CheckboxListTile(
                  title: Text(foodsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypefood,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = foodsst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtypereservation = !value;
                      searchtyperestaurant = !value;
                ...
                CheckboxListTile(
                  title: Text(eventsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypeevent,
                  onChanged: (bool value) {
                    setState(() {
                      searchtypeuser = !value;

                      chosensearchtype = calendareventsst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtypereservation = !value;
                      searchtyperestaurant = !value;
                ...
                CheckboxListTile(
                  title: Text(appointmentsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypeapp,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = calendaritemsst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtypereservation = !value;
                      searchtyperestaurant = !value;
                ...
                CheckboxListTile(
                  title: Text(reservationsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypereservation,
                  onChanged: (bool value) {
                    setState(() {
                      searchtypeuser = !value;
                      chosensearchtype = reservationsst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtypereservation = value;
                      searchtyperestaurant = !value;
                ...
                CheckboxListTile(
                  title: Text(jobapplicationsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypejobann,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = jobpostingst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtyperestaurant = !value;
                      searchtypereservation = !value;
                ...
                CheckboxListTile(
                  title: Text(formsst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypeforms,
                  onChanged: (bool value) {
                    setState(() {
                      searchtypeuser = !value;
                      chosensearchtype = userservicesst;
                      chosensearchtype2 = '';
                      searchtypeuser = !value;
                      searchtypereservation = !value;
                      searchtyperestaurant = !value;
                ...
                if (chosensearchtype == foodsst ||
                    chosensearchtype2 == groceryshoppingst)
                  Row(children: <Widget>[
                    Text(bycataloguest,
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 20)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (isstringnullsearch(pricelowinit.text) == false &&
                          isstringnullsearch(pricehighinit.text) == false) {
                        priceactivated = true;
                        pricelow = int.parse(pricelowinit.text);
                        pricehigh = int.parse(pricehighinit.text);
                      }
                      if (isstringnullsearch(pricelowinit.text) &&
                          isstringnullsearch(pricehighinit.text)) {
...
class SearchRestaurantTypeScreen extends StatefulWidget {
  ...
  const SearchRestaurantTypeScreen({Key key, this.user, this.category})
      : super(key: key);

  @override
  SearchRestaurantTypeScreenState createState() =>
      SearchRestaurantTypeScreenState(user: user, category: category);
}

class SearchRestaurantTypeScreenState
    extends State<SearchRestaurantTypeScreen> {
  final User user;
  final String category;
...
class ChangeStatusScreen extends StatefulWidget {
  final User user;
  final String category;
  const ChangeStatusScreen({Key key, this.user, this.category})
      : super(key: key);

  @override
  ChangeStatusScreenState createState() =>
      ChangeStatusScreenState(user: user, category: category);
}
...
class ChangeStatusScreenState extends State<ChangeStatusScreen> {
  ...
  EditUserIntensityChoice(String categorieschoices) {
    ...
    if (categorieschoices == busyst) {
      searchcrowdness = 'busy';
      Navigator.pop(context);
    }
    if (categorieschoices == normalst) {
      searchcrowdness = 'normal';
      Navigator.pop(context);
    }
    ...
    if (category == 'CR') {
      return Column(
        children: [
          ...
          ListTile(
            onTap: () {
              EditUserIntensityChoice(verybusyst);
            },
            title: Text(
              verybusyst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserIntensityChoice(busyst);
            },
            title: Text(
              busyst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserIntensityChoice(normalst);
            },
            title: Text(
              normalst,
              style:
