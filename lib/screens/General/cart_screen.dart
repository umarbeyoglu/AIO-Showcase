...
class GeneralCartScreen extends StatefulWidget {
  ...
  @override
  GeneralCartScreenState createState() => GeneralCartScreenState(user:user,);
}
...
class GeneralCartScreenState extends State<GeneralCartScreen> {
    ...
    for(int i=0;i<user.cartitems.length;i++){
      ...
      if(user.cartitems[i].countnow>1){
        for(int i2=0;i2<user.cartitems[i].choices.length;i2++){
          totalcartprice = totalcartprice + user.cartitems[i].choices[i2].price*(user.cartitems[i].countnow-1);
        }
      }
      for(int i2=0;i2<user.cartitems[i].choices.length;i2++){
  ...
  Widget build(BuildContext context) {
              ...
              Container(
                ...
                child:    Column(
                  children: [
                    ...
                    ListTile(
                      title: Text(cartst, style:TextStyle(color:colordtmaintwo,fontSize:MediaQuery.of(context).size.height*0.02,),),
                      trailing:   IconButton(
                    ...
                    if(isfood)  Row(
                        children: <Widget>[
                          ...
                          Text(deliveryoptionst,style:TextStyle(fontWeight:  FontWeight.w800,fontSize: 20)),
                    ...
                    if(isfood && pickup)
                      CheckboxListTile(
                      title:  Text(pickupst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                      value: deliverytypepickup, onChanged: (bool value) {setState(() {
                    ...
                    if(isfood && dinein) CheckboxListTile(
                      title:  Text(dineinst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                      value: deliverytypedinein, onChanged: (bool value) {setState(() {
                    ...
                    if(isfood && delivery) CheckboxListTile(
                      title:  Text(deliveryst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                      value: deliverytypedelivery, onChanged: (bool value) {setState(() {
                    ...
                    ListTile(
                      title: Text(deliverydatest, style:TextStyle(color:colordtmaintwo,fontSize:MediaQuery.of(context).size.height*0.02,),),
                      subtitle:  Text(deliveryday, style:TextStyle(color:Colors.black,fontWeight:FontWeight.bold,fontSize:MediaQuery.of(context).size.height*0.02,),),
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: deliverytimest,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
    ...
    trailing:   IconButton(
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: fullnamest,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: contactst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: addressst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: specialrequestst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
                    ...
                    Text('$totalcostst : ${totalcartprice.toString()}',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                    ...
                    //  onTap: ()async{await makePayment();},
                      onTap:(){
                        for(int i=0;i<user.cartitems.length;i++){
                              ...
                              CreateBuyNotification(user.cartitems[i], user.cartitems[i].author, user.cartitems[i].owner, user.cartitems[i].item, deliveryday, deliverytime.text, user.cartitems[i].link, user.cartitems[i].type, contact.text, address.text, specialrequest.text, fullname.text, deliveryday, chosendeliverytype, user.cartitems[i].count+(user.cartitems[i].countnow-1));
                              CreateBoughtCheck(user.cartitems[i], user.cartitems[i].author, user.cartitems[i].owner, user.cartitems[i].price, user.cartitems[i].count, user.cartitems[i].item, user.cartitems[i].link, user.cartitems[i].type, '', contact.text, fullname.text, deliveryday,chosendeliverytype, 0.0, address.text,specialrequest.text,deliverytime.text);
                     //       DeleteCartItem(user.cartitems[i].id);
                      ...
                      child: Container(
                        ...
                        color: Colors.green,
                        child: Center(
                          child: Text(payst , style: TextStyle(color: Colors.white , fontSize: 20),),
                        ),
                      ),
                    ),
    ...
    try {
      ...
      await Stripe.instance.initPaymentSheet(
          paymentSheetParameters: SetupPaymentSheetParameters(
              ...
              merchantDisplayName: 'WELPIE')).then((value){
      });
      try {
    ...
    final _calendarCarouselNoHeader = CalendarCarousel<Event>(
      ...
      onDayPressed: (date, events) {
        ...
        setState(() {
          searchday = date2;
          searchmny = mnyi;
          deliveryday = '$searchmny-$searchday';
        });
...
class CartItemScreen extends StatefulWidget {
  final User user;
  const CartItemScreen({Key key,this.user,}) : super(key: key);
  @override
                      ...
                      children: [
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (_) => VisitedProfileScreen(
                                        user: user,visiteduser: snapshot.data,
                                      )
                                  ),
                                );
                              },
                        ...
                        Row(
                          children: [
                              ...
                              child:     Text('''$itemst : \n'''
                                ...
                                ,style: TextStyle(
                                  fontSize: MediaQuery
                                      .of(context)
                                      .size
                                      .height * 0.03, color: colordtmaintwo,fontWeight: FontWeight.bold),),
                              onTap:(){
                                isuserfollowed(user.id,snapshot.data.id)..then((result){
                                  if(user.shouldshowuserinfo(snapshot.data,result) == 'followed'){FetchFollowedArticle(http.Client(),user.cartitems[index].link)..then((founditem){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => ArticleWidgetScreen(
                                          user:user,post: founditem,ischosing:false
                                        ),
                                      ),
                                    );
                                  });}
                                  if(user.shouldshowuserinfo(snapshot.data,result) == 'public'){FetchPublicArticle(http.Client(),user.cartitems[index].link)..then((founditem){    Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => ArticleWidgetScreen(
                                        user:user,post: founditem,ischosing:false
                            ...
                            InkWell(
                              child:     Text('''${user.cartitems[index].item.toString()} \n'''
                              ...
                              onTap:(){
                                isuserfollowed(user.id,snapshot.data.id)..then((result){
                                  if(user.shouldshowuserinfo(snapshot.data,result) == 'followed'){FetchFollowedArticle(http.Client(),snapshot.data.id)..then((founditem){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => ArticleWidgetScreen(
                                  ...
                                  if(user.shouldshowuserinfo(snapshot.data,result) == 'public'){FetchPublicArticle(http.Client(),snapshot.data.id)..then((founditem){    Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => ArticleWidgetScreen(
                                        user:user,post: founditem,ischosing:false
                            ...
                            Text('''$totalcostst: \n'''
                              ,style: TextStyle(
                                fontSize: MediaQuery
                                    ...
                                    .size
                                    .height * 0.03, color: colordtmaintwo,fontWeight: FontWeight.bold),),
                            Text('''${user.cartitems[index].price.toString()} \n'''
                              ,style: TextStyle(
                                fontSize: MediaQuery
                                    .of(context)
                                    .size
                        ...
                        Row(
                          children: [
                            Text('''$countst : '''
                              ,style: TextStyle(
                                fontSize: MediaQuery
                                    ...
                                    .size
                                    .height * 0.03, color: colordtmaintwo,fontWeight: FontWeight.bold),),
                            Text('''${user.cartitems[index].countnow.toString()}'''
                              ,style: TextStyle(
                                fontSize: MediaQuery
                                    .of(context)
                                    .size
                            ...
                            SizedBox(width:20),
                            IconButton(
                              icon: Icon(Icons.add,color: colordtmaintwo,size:35),
                              onPressed: (){
                                setState(() {
                                  user.cartitems[index].countnow++;
                                  EditCartItemCount(user.cartitems[index],user.cartitems[index].countnow);
                                });
                              },
                            ),
                            SizedBox(width:30),
                            IconButton(
                              icon: Icon(Icons.remove,color: colordtmaintwo,size:35),
                              onPressed: (){
                                setState(() {
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              icon: Icon(Icons.reorder,color: colordtmaintwo,size: 35,),
                              onPressed: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (_) => CartItemChoiceScreen(
                                        user: user,choices:user.cartitems[index].choices,
                                      )
                                  ),
                                );
                              },
...
class CartItemChoiceScreen extends StatefulWidget {
  ...
  const CartItemChoiceScreen({Key key,this.user,this.choices }) : super(key: key);
  @override
  CartItemChoiceScreenState createState() => CartItemChoiceScreenState(user: user,choices:choices);
}
