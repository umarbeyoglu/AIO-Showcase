...
import 'package:Welpie/screens/General/choice_screen.dart';
...
class EditPostScreen extends StatefulWidget {
  ...
  const EditPostScreen({Key key,this.category,this.day,this.dayfull,this.mnyinit, this.user,this.post}) : super(key: key);

  @override
  EditPostScreenState createState() => EditPostScreenState(user: user,post:post,dayfull: dayfull,day:day,
      category2:category,mnyinit: mnyinit);
}

class EditPostScreenState extends State<EditPostScreen> with SingleTickerProviderStateMixin {
  final User user;
  final Article post;
  ...
  final String dayfull;
  final String mnyinit;
  EditPostScreenState( {Key key, this.user,this.post,this.category2,this.day,this.dayfull,this.mnyinit,});
  ...
  String editor(String original) {return original;}
  ...
  void init(){
    ...
    if(isintnull(post.price)){price.text = '';}
    if(isintnull(post.stock)){stock.text = '';}
    if(isstringnull(post.deliveryfee)){deliveryfee.text = '';}
    if(isintnull(post.price) == false){price.text = post.price.toString();}
    if(isintnull(post.stock) == false){stock.text = post.stock.toString();}
    if(isstringnull(post.deliveryfee) == false){deliveryfee.text = post.deliveryfee.toString();}
    post.initeditbool();
    done = true;
    return;
  }
  ...
  @override
  void initState() {
    FetchTagusers(globaltxt,page+1).then((value) {setState(() {_users.addAll(value);_usersForDisplay = _users;});});
    super.initState();
  }
        ...
        actions: [
          IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (_) => CalendarEventEditChoiceScreen(product: post, ),),);
          ...
          IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (_) => UserProductEditDetailCategoryScreen(product: post, ),),);
            ...
            child: Column(
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    post.category == 'D' ? Container(height: 0,width: 0,) : (post.category == 'E' ? Container(
                        child: SizedBox(
                          height: MediaQuery
                              .of(context)
                              .size
                          ...
                          child: Column(
                            children: <Widget>[
                              Container(
                                ...
                                child: Carousel(
                                  images: post.images.map((post)=>post.carouselimages()).toList()
                ...
                if(post.type == 'UP')   CheckboxListTile(
                ...
                if(post.type != 'A') CheckboxListTile(
                ...
                if(post.isbuyenabled ) CheckboxListTile(
                ...
                if((post.allowstocks )&&( post.isbuyenabled)) Padding(
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: posttagsst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                          hintText: eyposttagsst,labelStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                ...
                if(post.type == 'R'  && post.type == 'UP') Padding(
                  padding: EdgeInsets.only(
                      left: MediaQuery.of(context).size.width * 0.01,
                      right: MediaQuery.of(context).size.width * 0.01),
                  child: Container(
                ...
                for(final item in post.forms)
                  if(item.notshow != true) Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                    Text('${item.content}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.forms.length > 0)   Divider(color: colordtmaintwo,),


                if(post.checkboxes.length > 0)  Text(
                  'Checkboxes',
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.checkboxes)
                  if(item.notshow != true) Row(                    mainAxisAlignment: MainAxisAlignment.center,children: [
                    Text('${item.content}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.checkboxes.length > 0)   Divider(color: colordtmaintwo,),


                if(post.highlights.length > 0)  Text(
                  highlightsst,
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.highlights)
                  if(item.notshow != true) Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                    Text('${item.highlight}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.highlights.length > 0)   Divider(color: colordtmaintwo,),


                if(post.detailamenities.length > 0)  Text(
                  amenitiesst,
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.detailamenities)
                  if(item.notshow != true) Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                    Text('${item.amenity}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.detailamenities.length > 0)   Divider(color: colordtmaintwo,),



                if(post.detailrules.length > 0)  Text(
                  rulesst,
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.detailrules)
                  if(item.notshow != true) Row(                    mainAxisAlignment: MainAxisAlignment.center,children: [
                    Text('${item.rule}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.detailrules.length > 0)   Divider(color: colordtmaintwo,),



                if(post.detailincludeds.length > 0)  Text(
                  includedst,
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.detailincludeds)
                  if(item.notshow != true) Row(                    mainAxisAlignment: MainAxisAlignment.center,children: [
                    Text('${item.included}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.detailincludeds.length > 0)   Divider(color: colordtmaintwo,),


                if(post.travellocations.length > 0)  Text(
                  travellocationsst,
                  style: TextStyle(
                      fontSize: MediaQuery.of(context).size.height * 0.02,
                      fontWeight: FontWeight.bold
                ...
                for(final item in post.travellocations)
                  if(item.notshow != true) Row(                    mainAxisAlignment: MainAxisAlignment.center,children: [
                    Text('${item.location}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.travellocations.length > 0)   Divider(color: colordtmaintwo,),


                if(post.activities.length > 0)  Text(
                  activitiesst,
                  style: TextStyle(
                    fontSize: MediaQuery.of(context).size.height * 0.02,
                  fontWeight: FontWeight.bold
                ...
                for(final item in post.activities)
                 if(item.notshow != true) Row(                    mainAxisAlignment: MainAxisAlignment.center,children: [
                    Text('${item.activity}',  style: TextStyle(color: colordtmaintwo),),
                    IconButton(
                      icon: Icon(Icons. delete ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                      onPressed: () {
                ...
                if(post.activities.length > 0)   Divider(color: colordtmaintwo,),

                if(post.type == 'CE')  SizedBox(
             ...
             if(post.type != 'A')
              ...
              if(post.type == 'US')
                ...
                if(post.isbuyenabledinit  &&  post.allowstocksinit)  CheckboxListTile(
                  ...
                  onChanged: (bool value) {
                    setState(() { post.hideifoutofstockinit = value; });
                  },
                ...
                if(post.isbuyenabledinit  &&  post.allowstocksinit)  Padding(
                  padding: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.01 ,right: MediaQuery.of(context).size.width*0.01),
                  child:
                  Container(
                    margin: EdgeInsets.symmetric(horizontal:MediaQuery.of(context).size.width*0.023 , vertical: MediaQuery.of(context).size.height*0.013),
                ...
                if(post.type != 'A')  CheckboxListTile(
                  ...
                  value: post.isdeliveredinit,
                  onChanged: (bool value) {
                    setState(() { post.isdeliveredinit = value; });
                  },
                  secondary:  Icon(Icons.add_comment,color: colordtmaintwo),
                ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        int stockfinal = stock.text == '' ? 0 : int.parse(stock.text);
                        int pricefinal = price.text == '' ? 0 : int.parse(price.text);
                        int deliveryfeefinal =   deliveryfee.text == '' ? 0 : int.parse(deliveryfee.text);
                        EditArticle(caption.text, details.text, _tags.text,
                            usertagsfinal, post, stockfinal, deliveryfeefinal,
                            etatime.text, pricefinal, post.allowcommentsinit,post.anonymityinit,
                            post.isbuyenabledinit, post.isdeliveredinit, post.sensitiveinit,
                            post.spoilerinit, post.allowstocksinit, post.isimagerequiredinit,
                            post.hideifoutofstockinit, post.isforstayinit, post.isquestioninit, checkintime.text, checkouttime.text, startdate.text, enddate.text, readtime.text, deliveredfromtime.text, deliveredtotime.text,
                      ...
                      for(int i=0;i<activities.length;i++){
                        CreateArticleActivity(user.id, post.id, activities[i].item.text);
                      }

                      for(int i=0;i<detailincludeds.length;i++){
                        CreateArticleDetailIncluded( post.id, detailincludeds[i].item.text);
                      }

                      for(int i=0;i<detailrules.length;i++){
                        CreateArticleDetailRule( post.id, detailrules[i].item.text);
                      }
                      ...
                      for(int i=0;i<highlights.length;i++){
                        CreateArticleHighlight( post.id, highlights[i].item.text);
                      }

                      for(int i=0;i<travellocations.length;i++){
                        CreateArticleTravelLocation( post.id, travellocations[i].item.text);
                      }


                      for(int i=0;i<checkboxes.length;i++){
                        CreateUserServiceCheckBox(user.id, post.id, checkboxes[i].hint.text);
                      }
                      for(int i=0;i<forms.length;i++){
                        CreateUserServiceForms(user.id, post.id, forms[i].hint.text);
                      }
...
class CreatePostTaggedUserScreen extends StatefulWidget {
  ...
  const CreatePostTaggedUserScreen({Key key, this.user,this.article}) : super(key: key);

  @override
  CreatePostTaggedUserScreenState createState() => CreatePostTaggedUserScreenState(user: user,article:article);
}
