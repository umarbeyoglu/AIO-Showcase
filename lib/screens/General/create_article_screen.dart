...
final Article post;
final String type;
  CreateArticleScreen({Key key, this.user,this.type,this.post,}) : super(key: key);

  @override
  CreateArticleScreenState createState() => CreateArticleScreenState(user:user,post:post,type:type);
}
...
class CreateArticleScreenState extends State<CreateArticleScreen> {
  ...
  bool isbusatt(){
    if(businessatt){return true;}
    if(isjobposting){return true;}
    return false;
  }
  ...
  void _onImageButtonPressed(ImageSource source, {BuildContext context, bool isMultiImage = false}) async {
    ...
    if (isVideo) {
      final PickedFile file = await _picker.getVideo(source: source, maxDuration: const Duration(seconds: 60));
  ...
  Widget _previewImages() {
    ...
    if (_imageFileList != null) {
      return Container(
        ...
        child: Carousel(
          images:_imageFileList.map((peritem)=>carouselimages(peritem)).toList(),
          autoplay: false,
  ...
  _listItemUser(index) {
    return _usersForDisplay[index].id == user.id ? Container(height: 0,width: 0,) : (istagged(_usersForDisplay[index]) ? Container(height: 0,width: 0,) :
    InkWell(
  ...
  void initState() {
    ...
    FetchTagusers(globaltxt,page).then((value) {setState(() {
      _users.addAll(value);_usersForDisplay = _users;});});
    super.initState();
  }
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      CreateArticleExtendedDetailsScreen(
                        user: user,type:type,
                      ),
                ),
              );
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child:  Column(
              children: [
                SizedBox(
                  height: waiting == true ? MediaQuery
                      .of(context)
                      .size
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: captionst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText:detailsst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                        ),
                      ),
                    ),
                  ),
                ...
                if((allowstocks )&&( isbuyenabled)) Padding(
                  padding: EdgeInsets.only(
                      left: MediaQuery.of(context).size.width * 0.01,
                      right: MediaQuery.of(context).size.width * 0.01),
                  child: Container(
                ...
                if(type != 'UP' && type != 'A' && type != 'OFFER') Padding(
                  padding: EdgeInsets.only(
                      left: MediaQuery.of(context).size.width * 0.01,
                      right: MediaQuery.of(context).size.width * 0.01),
                  child: Container(
                        ...
                        child:  Padding(
                          ...
                          child:Form(
                            child:TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: taguserssst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                                border: InputBorder.none,
                                focusedBorder: InputBorder.none,
                                enabledBorder: InputBorder.none,
                                errorBorder: InputBorder.none,
                                ...
                                suffixIcon:  IconButton(
                                  icon: Icon(Icons. people ,color: colordtmaintwo,size: MediaQuery.of(context).size.width*0.065),
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                              ...
                              onChanged: (_textfield) {
                                ...
                                setState(() {
                                  ...
                                  _users = [];
                                  _usersForDisplay = [];
                                  SearchUsersNew2(page,_textfield.toLowerCase(),_textfield.toLowerCase().split(','),false,false).then((value) {setState(() {_users.addAll(value);_usersForDisplay = _users;});});
                ...
                SizedBox(
                  height:searching == false ? 0 : _usersForDisplay.length*80.0,
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child:   ListView.builder(
                      itemBuilder: (context, index) {
                        return searching == false ? Container(height: 0,width: 0,) : _listItemUser(index); },
              ...
              if(type == 'US')  CheckboxListTile(
                ...
                if(type != 'A' && type != 'OFFER')    CheckboxListTile(
                  title:  Text(isbuyenabledst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: isbuyenabled,
                  onChanged: (bool value) {
                    setState(() { isbuyenabled = value; });
                  },
                  secondary:  Icon(Icons.add_comment,color: colordtmaintwo),
                ), //isbuyenabled
                if(isbuyenabled)  CheckboxListTile(
                  title:  Text(allowstocksst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: allowstocks,
                  onChanged: (bool value) {
                    setState(() {
                      allowstocks = value;
                ...
                if(isbuyenabled  &&  allowstocks)  Padding(
                  padding: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.01 ,right: MediaQuery.of(context).size.width*0.01),
                  child:
                  Container(
                    margin: EdgeInsets.symmetric(horizontal:MediaQuery.of(context).size.width*0.023 , vertical: MediaQuery.of(context).size.height*0.013),
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: stockst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                        ),
                      ),
                    ),
                  ),
                ...
                if(isbuyenabled  &&  allowstocks)  CheckboxListTile(
                  title:  Text(hideifoutofstockst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: hideifoutofstock,
                  onChanged: (bool value) {
                    setState(() { hideifoutofstock = value; });
                  },
                  secondary:  Icon(Icons.add_comment,color: colordtmaintwo),
                ), //hideifoutofstock
                if(type != 'A' && type != 'OFFER')  CheckboxListTile(
                  title:  Text(isdeliveredst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: isdelivered,
                  onChanged: (bool value) {
                ...
                CheckboxListTile(
                  title:  Text(disablecommentsst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: disablecomments,
                  onChanged: (bool value) {
                    setState(() { disablecomments = value; });
                  },
                  secondary:  Icon(Icons.add_comment,color: colordtmaintwo),
                ),
                CheckboxListTile(
                  title:  Text(disablestatsst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: disablestats,
                  onChanged: (bool value) {
                    setState(() { disablestats = value; });
                  },
                  secondary:  Icon(Icons.format_list_numbered,color: colordtmaintwo),
                ),

                CheckboxListTile(
                  title:  Text(sensitivest,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: issensitive,checkColor: Colors.white,selectedTileColor: Colors.white,
                  onChanged: (bool value) {
                    setState(() { issensitive = value; });
                  },
                  secondary:  Icon(Icons.format_list_numbered,color: colordtmaintwo),
                ),
                CheckboxListTile(
                  title:  Text(spoilerst,style: TextStyle(color:colordtmaintwo,fontWeight:  FontWeight.w400)),
                  value: isspoiler,
                  onChanged: (bool value) {
                    setState(() { isspoiler = value; });
                  },
                  secondary:  Icon(Icons.format_list_numbered,color: colordtmaintwo),
                ),


                if(isdelivered) Padding(
                  padding: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.01 ,right: MediaQuery.of(context).size.width*0.01),
                  child:
                  Container(
                    margin: EdgeInsets.symmetric(horizontal:MediaQuery.of(context).size.width*0.023 , vertical: MediaQuery.of(context).size.height*0.013),
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: deliveryfeest,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child:  Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: etatimest,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                        ),
                      ),
                    ),
                  ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) => Calendar(
                              user:user,calendarowner: user,issearch: false,
                            )
                        ),
                      );
                    },
                ...
                SizedBox(
                  ...
                  onPressed: () {
                    setState(() {
                        ...
                        int  finalprice = price.text == '' ? 0 : int.parse(price.text);
                        int  finalstock = stock.text == '' ? 0 : int.parse(stock.text);
                        int  finaldeliveryfee = deliveryfee.text == '' ? 0 : int.parse(deliveryfee.text);

                        int  finaladults = adults.text == '' ? 0 : int.parse(adults.text);
                        int  finalkids = kids.text == '' ? 0 : int.parse(kids.text);
                        int  finalbathrooms = bathrooms.text == '' ? 0 : int.parse(bathrooms.text);
                        int  finalbedrooms = bedrooms.text == '' ? 0 : int.parse(bedrooms.text);
                        print('a: ${highlights.length}');

                        CreateArticle(user, caption.text, details.text, disablecomments, disablestats, issensitive, isspoiler, tags.text, _imageFileList, taggedusers, false, '',
                            video, isjobposting, articlecreatecategory, finalprice, isbuyenabled, finalstock, isdelivered, finaldeliveryfee, etatime.text, allowstocks, isimagerequired, forms,
                            checkboxes,type,
                            hideifoutofstock, isforstay, isquestion, checkintime.text, checkouttime.text, startdate.text, enddate.text, readtime.text, deliveredfromtime.text, deliveredtotime.text,
                            specialinstructions.text, guide.text, pricecurrency.text, pricetype.text, finaladults, finalkids, finalbathrooms, finalbedrooms,
                            activities, highlights, travellocations, amenities, detailcategories, [], detailincludeds, detailrules,productcondition.text,ceday);
                           if(type != 'A'){Navigator.pop(context);}
                     if(type == 'A'){Future.delayed(new Duration(seconds:1), () {Navigator.push(context, MaterialPageRoute(builder: (_) => HomeScreen(user: user,),),);});}
...
class UserProductCategoryCreateScreen extends StatefulWidget {
  ...
  @override
  UserProductCategoryCreateScreenState createState() => UserProductCategoryCreateScreenState(user:user);
}

class UserProductCategoryCreateScreenState extends State<UserProductCategoryCreateScreen> {
  final User user;
                        ...
                        child:  Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: categoryst,hintStyle: TextStyle(fontWeight:  FontWeight.w400,color: colordtmaintwo),
                            ),
                          ),
                        ),
                      ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          if(image?.path != null){
                            FileSizeLimitImage(image.path)..then((value){
                              if(value){print('File too big to upload!');
                              return;}
                              if(value == false){
                                CreateUserProductCategory(item.text,user.id,image);
                              }
                            });
...
class CreateDetailCategoryScreen extends StatefulWidget {
  ...
  const CreateDetailCategoryScreen({Key key, }) : super(key: key);
  @override
  CreateDetailCategoryScreenState createState() => CreateDetailCategoryScreenState();
}

class CreateDetailCategoryScreenState extends State<CreateDetailCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        physics: AlwaysScrollableScrollPhysics(),
        children: <Widget>[
          Text('Detail Cat',style: TextStyle(color:Colors.black),),
          for (final item in detailcategories)
            Column(
              children: [
                ...
                for (final item2 in item.detailspecs)Column(
                  children: [
                    Row(
                      children: [
                        SizedBox(width:10),      Text('Item ${item2.item.text}',style:TextStyle(
                            fontWeight: FontWeight.w400,
                            color: colordtmaintwo),),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        SizedBox(width:10),   Text('Delete Spec',style:TextStyle(
                            fontWeight: FontWeight.w400,
                            color: colordtmaintwo),),    IconButton(
                ...
                Row(
                  children: [
                    SizedBox(width:10),   Text('Delete Category',style:TextStyle(
                        fontWeight: FontWeight.w400,
                        color: colordtmaintwo),),     IconButton(
                      icon: Icon(Icons.delete),
                      iconSize: 30.0,
                    ...
                    Text('Add Item',style:TextStyle(
                      ...
                      onPressed: () {
                        setState(() {
                          DetailSpecModel model =
                          DetailSpecModel(item: TextEditingController(text: ""));
                ...
                SizedBox(height:50),
                Text('End of Category ${item.item.text}',style:TextStyle(
                    fontWeight: FontWeight.w400,
                    color: colordtmaintwo),),
                Divider(color: colordtmaintwo,thickness: 3,),
...
class CreatePostTaggedUserScreen extends StatefulWidget {
  ...
  @override
  CreatePostTaggedUserScreenState createState() => CreatePostTaggedUserScreenState(user: user);
}

class CreatePostTaggedUserScreenState extends State<CreatePostTaggedUserScreen> {
  final User user;
        ...
        body:  ListView(
          ...
          children: <Widget>[
            Column(
               children: [
                 SizedBox(height:20),
                 Text(clickusertountag,style:TextStyle( color: colordtmaintwo,
                   fontSize: MediaQuery.of(context).size.height*0.03,
                   fontWeight: FontWeight.bold,)),
                 Divider(color: colordtmaintwo,),
                 Column(
                         ...
                         return InkWell(
                           ...
                           child:Container(
                             ...
                             child: ListTile(
                               ...
                               title:   CircleAvatar(
                                 radius:MediaQuery.of(context).size.height*0.045,
                                 backgroundImage: NetworkImage(taggedusers[index].image == null ?'https://st2.depositphotos.com/4111759/12123/v/600/depositphotos_121233262-stock-illustration-male-default-placeholder-avatar-profile.jpg' : taggedusers[index].image ),
                               ),
...
class CreateArticleExtendedDetailsScreen extends StatefulWidget {
  final User user;
  final String type;
  const CreateArticleExtendedDetailsScreen({Key key, this.type,this.user}) : super(key: key);
  @override
  CreateArticleExtendedDetailsScreenState createState() => CreateArticleExtendedDetailsScreenState(type:type,user:user);
}

class CreateArticleExtendedDetailsScreenState extends State<CreateArticleExtendedDetailsScreen> {
  final User user;
  final String type;
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child:ListTile(
                      ...
                      title: Text(creatememest,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => SelectMeme(
                  ...
                  Divider(color: colordtmaintwo,),
    if(type != 'A' &&  type != 'OFFER') InkWell(
                    child:ListTile(

                      title: Text(movearticleinsideacategoryst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                      subtitle: articlecreatecategory != '' ? Text('$chosencategoryst : $articlecreatecategory',style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)) : Container(height:0,width:0),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => UserFilterCategoryScreen(
                            user: user,visiteduser: user,isarticlecreate: true,
                            )
                        ),
                      );
                    },
                  ),
                  if(type != 'A' &&  type != 'OFFER')    Divider(color: colordtmaintwo,),
                  if(type != 'A' &&  type != 'OFFER' &&type != 'US' && type != 'CI')  InkWell(
                    child:ListTile(

                      title: Text(addchoicest,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => CreateChoiceScreen(
                  ...
                  if(type != 'A' &&  type != 'OFFER' &&type != 'US' && type != 'CI')Divider(color: colordtmaintwo,),
                  if(type != 'A' && type != 'OFFER') InkWell(
                    child:ListTile(

                      title: Text(addextendeddetailsst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'CE')  InkWell(
                    child:ListTile(
                      ...
                      title: Text(addactivityst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
...
type: addactivityst,
                  ...
                  if(type == 'CE')  Divider(color: colordtmaintwo,),
                  if(type != 'A' && type != 'OFFER') InkWell(
                    child:ListTile(

                      title: Text(adddetailincludedst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  Divider(color: colordtmaintwo,),
                  if(type != 'A' && type != 'OFFER')  if(type != 'A'&& type != 'OFFER') InkWell(
                    child:ListTile(

                      title: Text(addrulesst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type != 'A'&& type != 'OFFER') Divider(color: colordtmaintwo,),
                  if(type == 'UP' || type == 'R')  InkWell(
                    child:ListTile(

                      title: Text(addamenitiesst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'UP' || type == 'R')  Divider(color: colordtmaintwo,),
                  if(type != 'A'&& type != 'OFFER') InkWell(
                    child:ListTile(

                      title: Text(addhighlightsst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'US')  InkWell(
                    child:ListTile(
                      ...
                      title: Text(addformst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'US')  Divider(color: colordtmaintwo,),
                  if(type == 'US') InkWell(
                    child:ListTile(

                      title: Text(addcheckboxst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'R') InkWell(
                    child:ListTile(
                      ...
                      title: Text(addtravellocationsst,style: TextStyle(color: colordtmaintwo,fontWeight: FontWeight.bold)),
                    ),
                    onTap: (){
                      Navigator.push(
                        context,
                  ...
                  if(type == 'R') Divider(color: colordtmaintwo,),
...
class CreateArticleExtendedDetails2Screen extends StatefulWidget {
  ...
  final String type;
  const CreateArticleExtendedDetails2Screen({Key key, this.type,}) : super(key: key);
  @override
  CreateArticleExtendedDetails2ScreenState createState() => CreateArticleExtendedDetails2ScreenState(type:type);
}

class CreateArticleExtendedDetails2ScreenState extends State<CreateArticleExtendedDetails2Screen> {

  final String type;
  CreateArticleExtendedDetails2ScreenState({Key key,this.type, }) ;
  ...
  void typedetector(){
    if(type == addtravellocationsst){
      setState(() {
        ...
        travellocations.add(model);return;
      });
    }
    if(type == addcheckboxst){
      setState(() {
        ...
        checkboxes.add(model);return;
      });

    }
    if(type == addformst){ setState(() {
      FormModel model =
      FormModel(hint: TextEditingController(text: ""));
      forms.add(model);return;
    });

    }
    if(type == addhighlightsst){ setState(() {
      HighlightModel model =
      HighlightModel(item: TextEditingController(text: ""));
      highlights.add(model);return;
    });

    }
    if(type == addamenitiesst){ setState(() {
      AmenityModel model =
      AmenityModel(item: TextEditingController(text: ""));
      amenities.add(model);return;
    });

    }
    if(type == addactivityst){ setState(() {
      ActivityModel model =
      ActivityModel(item: TextEditingController(text: ""));
      activities.add(model);return;
    });

    }
    if(type == adddetailincludedst){ setState(() {
      DetailIncludedModel model =
      DetailIncludedModel(item: TextEditingController(text: ""));
      detailincludeds.add(model);return;
    });

    }
    if(type == addrulesst){ setState(() {
      DetailRuleModel model =
      DetailRuleModel(item: TextEditingController(text: ""));
      detailrules.add(model);return;
    });
