...
class NotificationsScreen extends StatefulWidget {
  ...
  NotificationsScreenState createState() =>
      NotificationsScreenState(user: user);
}
...
class NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future _loadData() async {
    FetchNotificationNew(user, page)
      ..then((result) {
        setState(() {
...
//Widget RequestType(User user,Request request,List<Group> usergroups)
            ...
            return snapshot.hasData
                ? InkWell(
                    child: ListTile(
                      ...
                      title: Text(
                        '${snapshot.data.comments} $userst $articlecommentst',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: colordtmaintwo,
                          fontSize: MediaQuery.of(context).size.height * 0.024,
    ...
    if (notification.type == 'SubuserUserComment') {
      return InkWell(
        child: ListTile(
          ...
          title: Text(
            '${user.comments} $userst $usercommentst',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: colordtmaintwo,
              fontSize: MediaQuery.of(context).size.height * 0.024,
  ...
  bool notificationcategorywidget(Notifications notification) {
    if (notificationcategory == NotificationCategories2.All) {
      return true;
    }
    if (notificationcategory == NotificationCategories2.Order) {
    ...
    if (notificationcategory == NotificationCategories2.Request) {
      if (notification.requesttype == 'follow' ||
          notification.requesttype == 'userservice' ||
          notification.requesttype == 'calendar') {
        return true;
      }
    }
    if (notificationcategory == NotificationCategories2.Notification) {
      if (notification.type == 'SubuserUserComment' ||
          notification.type == 'UserComment' ||
          notification.type == 'SubuserArticleComment' ||
          notification.type == 'ArticleComment' ||
          notification.type == 'SubuserTaggedArticle' ||
          notification.type == 'UserTaggedArticle') {
        return true;
      }
    }
    return false;
  ...
  Widget NotificationType(User user, Notifications notification) {
            ...
            return snapshot.hasData
                ? InkWell(
                    child: ListTile(
                      ...
                      title: Text(
                        '${snapshot.data.comments} $userst $userservicecommentst',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: colordtmaintwo,
                          fontSize: MediaQuery.of(context).size.height * 0.024,
          ...
          builder: (context, snapshotcsrr) {
            ...
            return snapshotcsrr.hasData
                ? InkWell(
                    ...
                    onTap: () {
                      FetchOwnArticle(notification.link)
                        ..then((result) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      FollowUser(notification.author,
                    ...
                    ? InkWell(
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => RequestDenyDetailsScreen(
                                  user: user,
                                  visiteduser: user,
                                  category: '',
                                  userproduct: notification,
                                  deny: true)));
                        },
                      )
                    : Center(
    ...
    if (notification.requesttype == 'userservice' &&
        isserviceaccepted(notification)) {
      return notification.show == false
          ? Container(
              height: 0,
              width: 0,
              ...
              builder: (context, snapshotufr) {
                ...
                return snapshotufr.hasData
                    ? InkWell(
                        ...
                        onTap: () {
                          isuserfollowed(user.id, snapshotufr.data.id)
                            ..then((result) {
                              if (user.shouldshowuserinfo(
                                      snapshotufr.data, result) ==
                                  'followed') {
                                setState(() {
          ...
          builder: (context, snapshotcsr) {
            ...
            return snapshotcsr.hasData
                ? InkWell(
                    ...
                    onTap: () {
                      isuserfollowed(user.id, snapshotcsr.data.id)
                        ..then((result) {
                          if (user.shouldshowuserinfo(
                                  snapshotcsr.data, result) ==
                              'followed') {
                            setState(() {
                              FetchFollowedArticle(
                                http.Client(),
    ...
    if (notification.requesttype == 'calendar') {
      if (notification.isdenied) {
        return notification.author == user.id
            ? (notification.clientnow
                ? (notification.show == false
                    ? Container(
                        height: 0,
                        width: 0,
                                        ...
                                        child: ElevatedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              CreateCalendarSchedule(
                                                  ...
                                                  notification.date,
                                                  notification.time);
                                              RemoveCalendarScheduleRequest(
                                                  notification.id);
                                              AcceptCalendarRequest(
                                                  notification.profile,
                                                  notification.author,
                                                  notification,
                                                  true,
                                      ...
                                      SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            RemoveCalendarScheduleRequest(
                                                notification.id);
                                            CreateCalendarScheduleRequesttype2(
                                                user.id,
                                                notification.author,
                                                notification.item,
                                                notification.date,
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    notification.isdenied == true
                                        ? '''${snapshotcsrr.data.username} $deniedcalendarst'''
                                        : '''$sentcalendarrequestst \n'''
                                            ''' $itemst: ${notification.item} $datest ${notification.date} ${notification.time}''',
                                    style: TextStyle(
                                      color: colordtmaintwo,
                                      fontSize:
                              ...
                              ? InkWell(
                                  child: ListTile(
                                    ...
                                    title: Text(
                                      notification.isdenied == true
                                          ? '''${snapshotcsrr.data.username} $deniedcalendarst'''
                                          : '''${snapshotcsrr.data.username} $sentreservationrequestst \n'''
                                              '''\n '''
                                          ...
                                          child: ElevatedButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                CreateReservationSchedule(
                                                    ...
                                                    notification.date,
                                                    notification.time);
                                                RemoveReservationScheduleRequest(
                                                    notification.id);
                                                AcceptReservationScheduleRequest(
                                                    notification.profile,
                                                    notification.author,
                                                    notification,
                                                    true,
          ...
          actions: [
            PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) {
                return NotificationCategories2.notificationchoices
                ...
                ? NotificationListener<ScrollNotification>(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                            if (notificationcategorywidget(
                                snapshot.data[index]))
                              Divider(color: colordtmaintwo),
                            if (notificationcategorywidget(
                                snapshot.data[index]))
                              NotificationType(user, snapshot.data[index]),
                          ],
                        );
                      },
                    ),
...
class CalendarTTScreen extends StatefulWidget {
  ...
  const CalendarTTScreen({Key key, this.user, this.request, this.date})
      : super(key: key);
  @override
  CalendarTTScreenState createState() =>
      CalendarTTScreenState(user: user, request: request, date: date);
}
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => DateChooseScreen(
                          user: user,
                          request: request,
                        )));
              },
...
class DateChooseScreen extends StatefulWidget {
  ...
  @override
  DateChooseScreenState createState() =>
      DateChooseScreenState(user: user, request: request);
}
  ...
  Widget build(BuildContext context) {
    final _calendarCarouselNoHeader = CalendarCarousel<Event>(
      ...
      onDayPressed: (date, events) {
        ...
        print(date2);
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => CalendarTTScreen(
                  user: user,
                  date: date2,
                  request: request,
                )));
...
class BuyDetailsScreen extends StatefulWidget {
  ...
  @override
  BuyDetailsScreenState createState() => BuyDetailsScreenState(
      item: item,
      user: user,
      deny: deny,
      visiteduser: visiteduser,
...
class RequestDenyDetailsScreen extends StatefulWidget {
  ...
  final bool deny;
  final String category;
  const RequestDenyDetailsScreen(
      {Key key,
      this.userproduct,
      this.visiteduser,
      this.user,
  ...
  @override
  RequestDenyDetailsScreenState createState() => RequestDenyDetailsScreenState(
      user: user,
      deny: deny,
      visiteduser: visiteduser,
      userproduct: userproduct,
...
class ViewRequestImageScreen extends StatefulWidget {
  ...
  @override
  ViewRequestImageScreenState createState() =>
      ViewRequestImageScreenState(image: image);
}
...
class RequestChoiceScreen extends StatefulWidget {
  ...
  @override
  RequestChoiceScreenState createState() => RequestChoiceScreenState(
        product: product,
      );
}
