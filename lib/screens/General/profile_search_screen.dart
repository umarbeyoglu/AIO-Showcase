...
class ProfileSearchScreen extends StatefulWidget {
  ...
  const ProfileSearchScreen({Key key, this.visiteduser, this.user})
      : super(key: key);

  @override
  ProfileSearchScreenState createState() =>
      ProfileSearchScreenState(user: user, visiteduser: visiteduser, key: key);
}
...
class ProfileSearchScreenState extends State<ProfileSearchScreen> {
  ...
  @override
  void initState() {
    fetchPostsfuture = SearchArticlesInProfile(
        visiteduser.id,
        page,
        globaltxt,
        globaltxt.split(','),
  ...
  Future _loadmoreposts(String type) async {
    ...
    postsinit = await SearchArticlesInProfile(
        visiteduser.id,
        page,
        globaltxt,
        globaltxt.split(','),
...
class ProfileSearchFilterScreen extends StatefulWidget {
  final User user;
  final User visiteduser;
  const ProfileSearchFilterScreen({Key key, this.visiteduser, this.user})
      : super(key: key);

  @override
  ProfileSearchFilterScreenState createState() =>
      ProfileSearchFilterScreenState(
          user: user, visiteduser: visiteduser, key: key);
}
              ...
              children: [
                ...
                CheckboxListTile(
                  title: Text(offersst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold)),
                  value: searchtypeoffer,
                  onChanged: (bool value) {
                    setState(() {
                      chosensearchtype = offersst;
                      chosensearchtype2 = '';
