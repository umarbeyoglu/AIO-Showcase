...
import 'package:untitled/models/Article_Model/article_tag_model.dart';
...
import 'package:untitled/screens/General/feed_screen.dart';
import 'package:untitled/screens/General/notifications_screen.dart';
import 'package:untitled/screens/General/search_screen.dart';
        ...
        builder: (context, snapshot) {
          ...
          return snapshot.hasData ? Scaffold(
              body: PageView(
                ...
                children: <Widget>[
                  ClipsScreen(user: snapshot.data,),
                  SearchScreen(user:snapshot.data,),
                  user.profile_type == 'B' ? CreateArticleChooseScreen(user: snapshot.data) : CreateArticleScreen(user: snapshot.data,type:'A'),
              ...
              bottomNavigationBar: CupertinoTabBar(
                ...
                items: [
                  BottomNavigationBarItem(icon: Icon(Icons.home, size: MediaQuery.of(context).size.height*0.045, color: _currentTab == 0 ? Colors.blue :  colordtmaintwo,),),
                   BottomNavigationBarItem(icon: Icon(Icons.search, size: MediaQuery.of(context).size.height*0.045, color:_currentTab == 1 ? Colors.blue :  colordtmaintwo,),),
                  BottomNavigationBarItem(icon: Icon(Icons.add, size: MediaQuery.of(context).size.height*0.045, color:_currentTab == 2 ? Colors.blue :  colordtmaintwo,),),
                  BottomNavigationBarItem(icon: Icon(Icons.notifications_none, size: MediaQuery.of(context).size.height*0.045, color: _currentTab == 3 ? Colors.blue : colordtmaintwo,),),
                  BottomNavigationBarItem(icon: Icon(Icons.person_outline, size: MediaQuery.of(context).size.height*0.045, color: _currentTab == 4 ? Colors.blue : colordtmaintwo,),),
