...
class NotificationCategories2 {
  ...
  static const List<String> notificationchoices = <String>[
    All,
    Order,
    Request,
    Notification
...
class Categories {
  ...
  static const List<String> categorieschoices = <String>[
    All,
    Feedback,
    Insight,
    AccountHealth,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Stack(
                                                                    children: <
                                                                      ...
                                                                      Padding(
                                                                        padding:
                                                                            EdgeInsets.only(right: MediaQuery.of(context).size.height * 0.0),
                                                                        child:
                                                                            Column(
                                                                          crossAxisAlignment:
                                                                              ...
                                                                              children: [
                                                                                posts[index].articleliked(user.id, posts[index].liked, posts[index].unliked, posts[index].likeresult) == true
                                                                                    ? IconButton(
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          setState(() {
                                                                                            usercommentlikeid(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articleunlikeprocess(user.id, result);
                                                                                              });
                                                                                            isusercommentliked(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                    ...
                                                                                    : IconButton(
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          setState(() {
                                                                                            ...
                                                                                            usercommentdislikeid(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articleundislikeprocess(user.id, result);
                                                                                              });
                                                                                            isusercommentdisliked(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                ...
                                                                                InkWell(
                                                                                    child: Text(
                                                                                      posts[index].liked == true ? "${posts[index].likes + 1}" : "${posts[index].likes}",
                                                                                ...
                                                                                InkWell(
                                                                                    child: Text(
                                                                                      posts[index].disliked == true ? "${posts[index].dislikes + 1}" : "${posts[index].dislikes}",
                                                                                      textAlign: TextAlign.center,
                                                                                      style: TextStyle(
                                                                                        fontSize: MediaQuery.of(context).size.width * 0.04,
                                                                                        color: colordtmaintwo,
            ...
            children: <Widget>[
              ...
              IconButton(
                ...
                onPressed: () {
                  setState(() {
                    CreateUserComment(
                        user.id, user.id, _feedback.text, feedbackcategory);
                    _feedback.clear();
                    Future.delayed(new Duration(seconds: 1), () {
...
class VisitedFeedbackScreen extends StatefulWidget {
  ...
  const VisitedFeedbackScreen({Key key, this.user, this.visiteduser})
      : super(key: key);

  @override
  VisitedFeedbackScreenState createState() =>
      VisitedFeedbackScreenState(user: user, visiteduser: visiteduser);
}
...
class VisitedFeedbackScreenState extends State<VisitedFeedbackScreen> {
    ...
    isuserfollowed(user.id, visiteduser.id)
      ..then((result) {
        if (user.shouldshowuserinfo(visiteduser, result) == 'followed') {
          setState(() {
            fetchpostsfuture =
                FetchFollowedUserComments(http.Client(), visiteduser.id, page);
          });
          return;
        }
        if (user.shouldshowuserinfo(visiteduser, result) == 'public') {
          setState(() {
            fetchpostsfuture =
                FetchPublicUserComments(http.Client(), visiteduser.id, page);
          });
          return;
        }
      });
  ...
  Future<UserComment> RefreshList() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) =>
            VisitedFeedbackScreen(user: user, visiteduser: visiteduser),
      ),
    );
  }
          ...
          child: Row(
            children: <Widget>[
              ...
              IconButton(
                ...
                onPressed: () {
                  setState(() {
                    CreateUserComment(user.id, visiteduser.id, _feedback.text,
                        feedbackcategory);
                    _feedback.clear();
                    Future.delayed(new Duration(seconds: 1), () {
                      Navigator.pushReplacement(
...
class CommentsScreen extends StatefulWidget {
  ...
  CommentsScreenState createState() =>
      CommentsScreenState(user: user, post: post);
}
...
class CommentsScreenState extends State<CommentsScreen> {
  ...
  void initState() {
    ...
    if (user.id == post.author) {
      setState(() {
        fetchpostsfuture =
            FetchOwnArticleComments(http.Client(), post.id, page);
      });
      return;
    }
    FetchUser(post.author)
      ..then((authorresult) {
        isuserfollowed(user.id, post.author)
          ..then((result) {
            if (user.shouldshowuserinfo(authorresult, result) == 'followed') {
              setState(() {
                fetchpostsfuture = FetchOwnFollowedArticleComments(
                    http.Client(), post.id, page);
              });
              return;
            }
                              ...
                              return snapshot.hasData
                                  ? (snapshot.data.length == 0
                                      ...
                                      : ListView.builder(
                                          ...
                                          controller: _scrollController,
                                          itemBuilder: (context, index) {
                                            initstatsarticlecomment(
                                                posts[index], user);
                                            return FutureBuilder<User>(
                                                future: callUser(
                                                    posts[index].authorstring),
                                                builder: (context, snapshot) {
                                                  if (snapshot.hasError)
                                                    print(snapshot.error);
                                                                              ...
                                                                              children: [
                                                                                posts[index].articleliked(user.id, posts[index].liked, posts[index].unliked, posts[index].likeresult) == true
                                                                                    ? IconButton(
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          setState(() {
                                                                                            articlecommentlikeid(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articleunlikeprocess(user.id, result);
                                                                                              });
                                                                                            isarticlecommentliked(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articleliked(user.id, posts[index].liked, posts[index].unliked, result);
                                                                                              });
                                                                                          });
                                                                                    ...
                                                                                    : IconButton(
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          setState(() {
                                                                                            ...
                                                                                            articlecommentdislikeid(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articleundislikeprocess(user.id, result);
                                                                                              });
                                                                                            isarticlecommentdisliked(user.id, posts[index].id)
                                                                                              ..then((result) {
                                                                                                posts[index].articledisliked(user.id, posts[index].liked, posts[index].unliked, result);
                                                                                              });
                                                                                          });
