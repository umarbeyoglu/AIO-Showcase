...
class CalendarScheduleDetailsScreen extends StatefulWidget {
  ...
  final User user;
  final User client;
  const CalendarScheduleDetailsScreen({
    Key key,
    this.client,
    this.calendaritem,
    this.user,
  ...
  @override
  CalendarScheduleDetailsScreenState createState() =>
      CalendarScheduleDetailsScreenState(
          user: user, client: client, calendaritem: calendaritem);
}

class CalendarScheduleDetailsScreenState
    extends State<CalendarScheduleDetailsScreen> {
  final CalendarSchedule calendaritem;
  final User user;
  final User client;
  CalendarScheduleDetailsScreenState({
