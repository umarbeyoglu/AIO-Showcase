...
class DateScreen extends StatefulWidget {
  ...
  @override
  DateScreenState createState() => DateScreenState(user:user,calendarowner:calendarowner);
}
            ...
            children: <Widget>[
             SizedBox(height:40),
              ...
              Container(
                ...
                if(dateschosen.isEmpty)    ElevatedButton(
              ...
              Row(
                ...
                children: [
                  Text('$chosendatesst : $dateschosen',style: TextStyle(fontSize: 22),)
                ],
              ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      child: Text(nextst, style:TextStyle(fontSize:MediaQuery.of(context).size.height*0.02,),),
                      ...
                      onPressed: (){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (_) => ItemScreen(user: user,ischosing:true,calendarowner: calendarowner
                        ),),);
                      },
                    ),),
                  SizedBox(height:100),
