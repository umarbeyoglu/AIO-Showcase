...
import 'calendar_status_screen.dart';
...
class Calendar extends StatefulWidget {
  ...
  Calendar({Key key,this.user,this.issearch,this.calendarowner}) : super(key: key);
  @override
  CalendarS createState() => new CalendarS(issearch:issearch,user:user,calendarowner:calendarowner);
}
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height:50),
              calendarowner.calendar_type == 'calendartype2' ? Row() : Container(
