...
import 'package:untitled/screens/Calendar_Screen/calendar_create_time_screen.dart';
        ...
        children: <Widget>[
          Container(
              ...
              Column(
                  ...
                  children: <Widget>[
                    SizedBox(height:10),
                    Text(timestatusexpst,style: TextStyle(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    if(category == 'UPC'){DeleteArticleCategory(id);}
                    if(category == 'USC'){DeleteArticleCategory(id);}
                    if(category == 'MS'){DeleteMessage(id);}
