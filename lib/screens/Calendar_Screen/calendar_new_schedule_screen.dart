...
class Dates {
  ...
  Dates(
      {this.day, this.datepass, this.days, this.times, this.month, this.year});
}
...
class ScheduleScreenNew extends StatefulWidget {
  ...
  @override
  ScheduleScreenNewState createState() => ScheduleScreenNewState(
      user: user,
      itemlink: itemlink,
...
class ScheduleScreenNewState extends State<ScheduleScreenNew> {
  ...
  String monthfunc(String month) {
    if (month == '01' && languagest == 'EN') {
      return 'Jan';
    }
    if (month == '02' && languagest == 'EN') {
      return 'Feb';
    }
    if (month == '03' && languagest == 'EN') {
      return 'Mar';
    }
    if (month == '04' && languagest == 'EN') {
      return 'Apr';
    }
    if (month == '05' && languagest == 'EN') {
      return 'May';
    }
    if (month == '06' && languagest == 'EN') {
      return 'Jun';
    }
    if (month == '07' && languagest == 'EN') {
      return 'Jul';
    }
    if (month == '08' && languagest == 'EN') {
      return 'Aug';
    }
    if (month == '09' && languagest == 'EN') {
      return 'Sep';
    }
    if (month == '10' && languagest == 'EN') {
      return 'Oct';
    }
    if (month == '11' && languagest == 'EN') {
      return 'Nov';
    }
    if (month == '12' && languagest == 'EN') {
      return 'Dec';
    }

    if (month == '01' && languagest == 'TR') {
      return 'Oca';
    }
    if (month == '02' && languagest == 'TR') {
      return 'Şub';
    }
    if (month == '03' && languagest == 'TR') {
      return 'Mar';
    }
    if (month == '04' && languagest == 'TR') {
      return 'Nis';
    }
    if (month == '05' && languagest == 'TR') {
      return 'May';
    }
    if (month == '06' && languagest == 'TR') {
      return 'Haz';
    }
    if (month == '07' && languagest == 'TR') {
      return 'Tem';
    }
    if (month == '08' && languagest == 'TR') {
      return 'Ağu';
    }
    if (month == '09' && languagest == 'TR') {
      return 'Eyl';
    }
    if (month == '10' && languagest == 'TR') {
      return 'Eki';
    }
    if (month == '11' && languagest == 'TR') {
      return 'Kas';
    }
    if (month == '12' && languagest == 'TR') {
      return 'Ara';
    }
  }
  ...
  void initState() {
    for (int i = 0; i < calendarowner.calendarstatuses.length; i++) {
      ...
      for (int i8 = 0; i8 < items.length; i8++) {
        if (items[i8] == itemname) {
          ...
          List<String> times =
              calendarowner.calendarstatuses[i].times.split(',');
          List<String> days2 =
              calendarowner.calendarstatuses[i].dates.split(',');
    ...
    for (int i = 0; i < datess.length; i++) {
      ...
      if (int.parse(datess[i].datepass) <= 0) {
        datess.removeAt(i);
      }
    }
    return;
