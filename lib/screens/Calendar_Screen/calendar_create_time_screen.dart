...
class CreateCalendarTimeScreen extends StatefulWidget {
  ...
  @override
  CreateCalendarTimeScreenState createState() =>
      CreateCalendarTimeScreenState(user: user);
}
...
class CreateMeetingTimeScreen extends StatefulWidget {
  ...
  @override
  CreateMeetingTimeScreenState createState() =>
      CreateMeetingTimeScreenState(user: user);
}
