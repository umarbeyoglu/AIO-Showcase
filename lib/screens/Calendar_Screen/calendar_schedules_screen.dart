    ...
    return Scaffold(
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return doesitembelongtoschedule(user.calendarschedules[index])
                ? FutureBuilder<User>(
                              ...
                              child: ListTile(
                                  title: Column(
                                    children: [
                                      ...
                                      Text(
                                        '''${user.calendarschedules[index].item.toString()} ''',
                                        style: TextStyle(
                                          fontSize: MediaQuery.of(context)
                                                  .size
                                                  .height *
                                      ...
                                      Text(
                                        '''$timest: ${user.calendarschedules[index].time.toString()} ''',
                                        style: TextStyle(
                                          fontSize: MediaQuery.of(context)
                                                  .size
                                                  .height *
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      RemoveCalendarSchedule(
                                          user.calendarschedules[index].id);
                                      String id = user.id ==
                                              user.calendarschedules[index]
                                                  .profile
                                          ? user.calendarschedules[index].author
                                          : user
                                              .calendarschedules[index].profile;
                                      CancelAppointment(
                                          user.id,
                                          id,
                                          user.calendarschedules[index].item,
                                          user.calendarschedules[index].date,
                                          user.calendarschedules[index].time,
                                          user.calendarschedules[index].item);
                                      Future.delayed(
                                          Duration(seconds: 1),
