...
import 'package:flutter_food_delivery_app/screens/Profile_Screen/profile_blocked_users_screen.dart';
import 'package:flutter_food_delivery_app/screens/Profile_Screen/profile_delete_screen.dart';
import 'package:flutter_food_delivery_app/screens/Profile_Screen/profile_edit_screen.dart';
...
import '../General/about_screen.dart';
          ...
          Container(
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  child: ListTile(
                    leading: Icon(Icons.lightbulb, color: colordtmaintwo),
                    title: Text(
                      darklightthemest,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold),
                ...
                InkWell(
                  child: ListTile(
                    leading: Icon(Icons.delete, color: colordtmaintwo),
                    title: Text(
                      deleteuserst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold),
                ...
                InkWell(
                  child: ListTile(
                    leading: Icon(Icons.logout, color: colordtmaintwo),
                    title: Text(
                      logoutst,
                      style: TextStyle(
                          color: colordtmaintwo, fontWeight: FontWeight.bold),
