...
class CreateArticleChooseScreen extends StatefulWidget {
  ...
  @override
  CreateArticleChooseScreenState createState() =>
      CreateArticleChooseScreenState(user: user);
}
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'A'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => UserProductCategoryCreateScreen(
                            user: user,
                          ),
                        ),
                      );
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'UP'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    child: ListTile(
                      leading:
                          Icon(Icons.calendar_month, color: colordtmaintwo),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'CI'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    child: ListTile(
                      leading: Icon(Icons.calendar_month_outlined,
                          color: colordtmaintwo),
                      title: Text(appointmentsettingsst,
                          style: TextStyle(
                              color: colordtmaintwo,
                              fontWeight: FontWeight.bold)),
                    ),
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'CE'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'R'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    child: ListTile(
                      leading:
                          Icon(Icons.newspaper_outlined, color: colordtmaintwo),
                      title: Text(formsst,
                          style: TextStyle(
                              color: colordtmaintwo,
                              fontWeight: FontWeight.bold)),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'US'),
                        ),
                      );
                    },
                  ),
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              CreateArticleScreen(user: user, type: 'OFFER'),
                        ),
                      );
                    },
                  ),
