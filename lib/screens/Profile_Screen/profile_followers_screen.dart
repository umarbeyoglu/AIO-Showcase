...
class FollowersScreen extends StatefulWidget {
  ...
  @override
  FollowersScreenState createState() => FollowersScreenState(user: user, );
}

class FollowersScreenState extends State<FollowersScreen> {
  final User user;
  FollowersScreenState({Key key,this.user,});
  ...
  @override
  void initState() {
    fetchPostsfuture = FetchUserFolloweds(http.Client(),user.id,page);
  }



  Future _loadData() async {
    FetchUserFolloweds(http.Client(),user.id,page)..then((result){
      setState(() {
