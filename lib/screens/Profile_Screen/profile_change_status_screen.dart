...
class ProfileChangeStatusScreen extends StatefulWidget {
  ...
  const ProfileChangeStatusScreen({Key key, this.user, this.category})
      : super(key: key);

  @override
  ProfileChangeStatusScreenState createState() =>
      ProfileChangeStatusScreenState(user: user, category: category);
}
    ...
    if (category == 'BS') {
      return Column(
        children: [
          ...
          ListTile(
            onTap: () {
              EditUserBusinessStatusChoice(operatingasusualst);
            },
            title: Text(
              operatingasusualst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserBusinessStatusChoice(underservicechangesst);
            },
            title: Text(
              underservicechangesst,
              style:
                  TextStyle(color: colordtmaintwo, fontWeight: FontWeight.bold),
            ),
          ),
          ...
          ListTile(
            onTap: () {
              EditUserBusinessStatusChoice(temporarilyclosedst);
            },
            title: Text(
              temporarilyclosedst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserBusinessStatusChoice(permanentlyclosedst);
            },
            title: Text(
              permanentlyclosedst,
              style:
    ...
    if (category == 'PR') {
      return Column(
        children: [
          ...
          ListTile(
            onTap: () {
              EditUserPriceRangeChoice(premiumst);
            },
            title: Text(
              premiumst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserPriceRangeChoice(highst);
            },
            title: Text(
              highst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserPriceRangeChoice(standardst);
            },
            title: Text(
              standardst,
              style:
          ...
          ListTile(
            onTap: () {
              EditUserPriceRangeChoice(lowst);
            },
            title: Text(
              lowst,
              style:
