...
class FollowingScreen extends StatefulWidget {
  ...
  const FollowingScreen({Key key, this.user, this.visiteduser})
      : super(key: key);

  @override
  FollowingScreenState createState() =>
      FollowingScreenState(user: user, visiteduser: visiteduser);
}
...
class FollowingScreenState extends State<FollowingScreen> {
  ...
  Future _loadData() async {
    FetchUserFollowings(http.Client(), user.id, page)
      ..then((result) {
        setState(() {
