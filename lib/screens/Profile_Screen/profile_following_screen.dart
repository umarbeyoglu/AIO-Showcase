...
class FollowingScreen extends StatefulWidget {
  ...
  const FollowingScreen({Key key,this.user,this.visiteduser}) : super(key : key);

  @override
  FollowingScreenState createState() => FollowingScreenState(user: user,visiteduser: visiteduser );
}

class FollowingScreenState extends State<FollowingScreen> {
  final User user;
  final User visiteduser;
  FollowingScreenState({Key key,this.user,this.visiteduser});
  ...
  @override
  void initState() {
    fetchPostsfuture = FetchUserFollowings(http.Client(),user.id,page);
  }



  Future _loadData() async {
FetchUserFollowings(http.Client(),user.id,page)..then((result){
  setState(() {
