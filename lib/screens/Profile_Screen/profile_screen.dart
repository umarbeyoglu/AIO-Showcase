...
import 'package:Welpie/screens/Profile_Screen/profile_change_status_screen.dart';
import 'package:Welpie/screens/Profile_Screen/profile_feed_screen.dart';
...
import 'package:Welpie/screens/Profile_Screen/profile_about_screen.dart';
import 'package:Welpie/screens/Profile_Screen/profile_followers_screen.dart';
import 'package:Welpie/screens/Profile_Screen/profile_following_screen.dart';
...
class ProfileScreen extends StatefulWidget {
  ...
  @override
  ProfileScreenState createState() => ProfileScreenState(user: user,visiteduser : visiteduser);
}
        ...
        children: [
          Column(
            children: <Widget>[
              ...
              user.image == null ? Container(height: 0,width: 0,) : InkWell(
                child: Column(
              ...
              SizedBox(height: MediaQuery
                  ...
                  .size
                  .height * 0.04,),
              checknullity(user.full_name) ? Text(
                "@${user.username}",
              ...
              SizedBox(height: MediaQuery
                  ...
                  .size
                  .height * 0.01,),
              checknullity(user.locationcountry) ? Container(height: 0,width: 0,) : Text(
                '${user.location()}',
                ...
                children: [
                  FittedBox(
                    ...
                    child: ElevatedButton(
                      child: Text(detailsst, style:TextStyle(fontSize:MediaQuery.of(context).size.height*0.02,),),
              ...
              SizedBox(height: MediaQuery
                  ...
                  .size
                  .height * 0.036,),
              if( user.profile_type == 'B' && user.ishotel)   Row(
                children: [
                  Expanded(
              ...
              if( user.profile_type == 'B')   Row(
                children: [
                  Expanded(
                    ...
                    child:   ListTile(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => ProfileChangeStatusScreen(user: user,category:'PR'),),);
                      },
                      title: Text(
                  ...
                  Expanded(
                    child:   ListTile(
                      onTap:(){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => ProfileChangeStatusScreen(user: user,category:'CR'),),);
                      },
                      title: Text(
              ...
              if( user.profile_type == 'B')   Row(
                children: [
                  ...
                  Expanded(
                    child:   ListTile(
                      onTap:(){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => EditWifiScreen(user: user),),);
                      },
                      title: Text(
                        'Wi-fi',
                        textAlign: TextAlign.center,
                  ...
                  Expanded(
                    child:   ListTile(
                      onTap:(){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => ProfileChangeStatusScreen(user: user,category:'BS'),),);
                      },
                      title: Text(
                  ...
                  children: <Widget>[
                    Expanded(
                      child:   InkWell(
                          ...
                          onTap: () {Navigator.push(context, MaterialPageRoute(builder: (_) => FollowingScreen(user: user),),);}),
                    ...
                    Expanded(
                      child:   InkWell(
                          ...
                          onTap: () {Navigator.push(context, MaterialPageRoute(builder: (_) => FollowersScreen(user: user),),);}),
