...
class EditUserScreen extends StatefulWidget {
  ...
  @override
  EditUserScreenState createState() =>
      EditUserScreenState(user: user, masteruser: masteruser);
}
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: usertagsst,
                          labelStyle: TextStyle(
                              fontWeight: FontWeight.w400,
                              color: colordtmaintwo),
                          hintText: eypersontagsst,
                          hintStyle: TextStyle(
                              fontWeight: FontWeight.w400,
                              color: colordtmaintwo),
                      ...
                      setState(() {
                        ...
                        image1a == null
                            ? EditUser(
                                ...
                                user.hotelclass,
                                user.ishotel)
                            : FileSizeLimitImage(image1a.path)
                          ..then((value) {
                            if (value) {
              ...
              children: <Widget>[
                ...
                if (user.profile_type == 'B')
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => EditHotelScreen(user: user)));
                    },
                  ),
                SizedBox(height: MediaQuery.of(context).size.height * 0.025),
...
class EditMerchantScreenState extends State<EditMerchantScreen>
    with SingleTickerProviderStateMixin {
  final User user;
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      EditUserMerchantInfo(
                          user,
                          '',
                          gatewayname.text,
                          gatewaymerchantid.text,
                          merchantid.text,
                          merchantname.text);
