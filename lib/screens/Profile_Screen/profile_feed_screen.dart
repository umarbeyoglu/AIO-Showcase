...
import 'package:untitled/profile_user_product_screen.dart';
...
class ProfileFeedScreenState extends State<ProfileFeedScreen> {
  ...
  Future _loadData() async {
    ...
    postsinit = await FetchOwnArticles(user.id, page, user, false, '', '', '','A');
    setState(() {
  ...
  @override
  void initState() {
    fetchPostsfuture = FetchOwnArticles(user.id, page, user, false, '', '', '','A');
  }
