...
import 'package:flutter_food_delivery_app/screens/Authentication_Screen/authentication_login_screen.dart';
import 'package:flutter_food_delivery_app/screens/General/choice_screen.dart';
import 'package:flutter_food_delivery_app/screens/General/comments_screen.dart';
import 'package:flutter_food_delivery_app/screens/General/home_screen.dart';
              ...
              actions: [
                InkWell(
                  ...
                  onTap: () {
                    ...
                    locationcitygl = '-';
                    print(
                        '$locationcountrygl $locationstategl $locationcitygl');
            ...
            return AlertDialog(
              ...
              content: CSCPicker(
                ...
                onStateChanged: (value) {
                  locationstategl = value;
                  glst = value;
                },
                onCityChanged: (value) {
                  locationcitygl = value;
                  glct = value;
                },
              ),
            );
...
EditCartItemCount(CartItem cartitem, int count) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/cartitems/${cartitem.id}/",
        data: formData,
...
EditUserPriceRange(User user, String intensity, dynamic context) async {
  ...
  try {
    ...
    Response response = await Dio().patch("$SERVER_IP/api/ownuser/${user.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditUser(
  ...
  imagename =
      image == null ? 'empty' : (imagename = image.path.split('/').last);
  try {
    if (imagename == 'empty') {
      ...
      await Dio().patch("$SERVER_IP/api/ownuser/$userid/",
          data: formDatee,
          options: Options(headers: {
            "Authorization": "Token ${globaltoken}"
          } // set content-length},
    ...
    FormData formData = new FormData.fromMap({
      ...
      'locationcountry': locationcountrygl == 'null'
          ? user1.locationcountry
          : locationcountrygl,
      'locationstate':
          locationstategl == 'null' ? user1.locationstate : locationstategl,
      'locationcity':
          locationcitygl == 'null' ? user1.locationcity : locationcitygl,
      'phone_number': phone == 'null' ? user1.phone_number : phone,
      'details': about == 'null' ? user1.details : about,
      "business_type":
          businesstype == 'null' ? user1.business_type : businesstype,
      'calendar_type':
          calendartype == 'null' ? user1.calendar_type : calendartype,
    ...
    Response response = await Dio().patch("$SERVER_IP/api/ownuser/$userid/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
CreatePostImage(String author, String article, File image) async {
  ...
  try {
    ...
    Response response = await Dio().post("$SERVER_IP/api/articleimages/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
...
CreateUserComment(
    String author, String receiver, String content, String category) async {
  try {
    FormData formData = new FormData.fromMap({
      'author': author,
      'profile': receiver,
    ...
    Response response = await Dio().post("$SERVER_IP/api/usercomments/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
...
Future<User> CreateMeetingScheduleRequest(String author, String profile,
    String date, String time, String link) async {
  final http.Response response = await http.post(
...
Future<List<MeetingStatus>> FetchOwnMeetingStatus(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/meetingstatuses/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  return parsed["results"] != null
      ? new List<MeetingStatus>.from(
          parsed["results"].map((x) => MeetingStatus.fromJSON(x)))
      : List<MeetingStatus>();
}
...
Future<User> CreateMeetingStatus(
    String author, User user, dynamic context) async {
  final http.Response response = await http.post(
  ...
  if (response.statusCode == 201) {
    ...
    final response = await http.get(
      Uri.parse("$SERVER_IP/api/meetingstatuses/?format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    final parsed = jsonDecode(utf8.decode(response.bodyBytes));
    List<MeetingStatus> item = parsed["results"] != null
        ? new List<MeetingStatus>.from(
            parsed["results"].map((x) => MeetingStatus.fromJSON(x)))
        : List<MeetingStatus>();
...
Future<User> CreateCalendarStatus(
    String author, User user, dynamic context) async {
  final http.Response response = await http.post(
  ...
  if (response.statusCode == 201) {
    ...
    final response = await http.get(
      Uri.parse("$SERVER_IP/api/calendarstatuses/?format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    final parsed = jsonDecode(utf8.decode(response.bodyBytes));
    List<CalendarStatus> item = parsed["results"] != null
        ? new List<CalendarStatus>.from(
            parsed["results"].map((x) => CalendarStatus.fromJSON(x)))
        : List<CalendarStatus>();
...
Future<User> CreateCalendarStatusCTT(
    String author, User user, dynamic context) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/calendarstatuses/"),
    headers: <String, String>{
  ...
  if (response.statusCode == 201) {
    ...
    final parsed = jsonDecode(utf8.decode(response.bodyBytes));
    List<CalendarStatus> item = parsed
        .map<CalendarStatus>((json) => CalendarStatus.fromJSON(json))
        .toList();
    user.calendarstatuses = item;
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => HomeScreen(user: user)));
...
Future<User> CreateCalendarSchedule(User user, String author, String profile,
    String item, String date, String time) async {
...
EditCalendarScheduleRequest(
  ...
  try {
    ...
    Response response = await Dio().patch("$SERVER_IP/api/requests/$id/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
    print(response.toString());
  } catch (e) {
...
Future<User> CancelAppointment(String author, String profile, String item,
    String date, String time, String link) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
...
Future<User> CreateCalendarScheduleRequest(String author, String profile,
    String item, String date, String time, String link) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
...
Future<User> CreateBuyNotification(
    CartItem cartitem,
    String author,
    String profile,
    String item,
  ...
  if (response.statusCode == 201) {
    ...
    for (int i = 0; i < cartitem.choices.length; i++) {
      CreateRequestItemChoice(
          author,
          responseinit.substring(7, 43),
          cartitem.choices[i].item,
          cartitem.choices[i].category,
          cartitem.choices[i].price);
    }
  } else {
    throw new Exception(response.body);
  }
...
Future<User> AcceptServiceRequest(
    String user1,
    String user2,
    bool clientnow,
    bool isdenied,
    ...
    List<ArticleCheckBox> checkboxes) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
  ...
  if (response.statusCode == 201) {
    ...
    for (int i = 0; i < checkboxes.length; i++) {
      print('entering');
      CreateUserServiceRequestCheckbox(
          itemid, checkboxes[i].hint, checkboxes[i].content);
    }
    for (int i = 0; i < forms.length; i++) {
      CreateUserServiceRequestForm(
          itemid, forms[i].hint, forms[i].content.text);
    }
...
Future<User> CreateUserServiceRequestForm(
    String request, String hint, String content) async {
  final http.Response response = await http.post(
...
Future<User> CreateUserServiceRequestCheckbox(
    String request, String hint, bool boolean) async {
  final http.Response response = await http.post(
...
CreateUserServiceRequestImage(String author, String request, File image) async {
  ...
  try {
    ...
    Response response = await Dio().post("$SERVER_IP/api/requestimages/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
...
Future<User> AcceptItemRequest(String author, String profile, String item,
    String date, String time, bool clientnow, bool link) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
...
Future<User> AcceptCalendarRequest(String user1, String user2,
    Notifications notif, bool clientnow, bool isdenied, bool isaccepted) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
...
Future<User> CreateCalendarScheduleRequesttype3(
    String author,
    String profile,
    String item,
    String date,
...
Future<User> CreateCalendarScheduleRequesttype2(
    String author,
    String profile,
    String item,
    String date,
...
Future<User> CreateCalendarScheduleRequestCTT(
    String author, String profile, String item) async {
  print('item: $item');
...
Future<User> CreateUserServiceRequest(
    String user1,
    String user2,
    bool clientnow,
    bool isdenied,
  ...
  if (response.statusCode == 201) {
    ...
    for (int i = 0; i < images.length; i++) {
      FileSizeLimitImage(images[i].path)
        ..then((value) {
          if (value) {
...
Future<User> FollowUserSilent(
    String id, bool bool, String author, String profile) async {
  print(bool);
...
Future<User> CreateReport(
    String author, String profile, String article, String issue) async {
  final http.Response response = await http.post(
...
Future<User> FetchUserPrivate(String userid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/unusers/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<int> FetchUserMC() async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/usermessagecount/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  var responseJson = jsonDecode(utf8.decode(response.bodyBytes));
  return UserMC.fromJSON(responseJson[0]).messagecount2 +
      UserMC.fromJSON(responseJson[0]).messagecount;
}

Future<User> FetchPublicUser(String userid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicusers/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<User> FetchFollowedUser(String userid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/followedusers/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<Widget> FetchPublicUserNav(
    User muser, String userid, dynamic context) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicusers/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
  ...
  return Navigator.push(
    ...
    MaterialPageRoute(
        builder: (_) => VisitedProfileScreen(
              user: muser,
              visiteduserid: '',
              visiteduser: User.fromJSON(responseJson),
            )),
  );
}

Future<Widget> FetchFollowedUserNav(
    User muser, String userid, dynamic context) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/followedusers/$userid/?format=json"),
    headers: <String, String>{
...
Future<Article> FetchArticle(String postid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articles/$postid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<Article> FetchOwnArticle(String postid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/fetcharticles/$postid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Meme>> FetchMemes() async {
  final response = await http.get(
    Uri.parse("https://api.memegen.link/templates"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8'
    },
  );
...
Future<List<User>> RegisteringCheck() async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/registeringcheck/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8'
    },
  );
...
Future<List<User>> FetchRegisteredUsers() async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/registeredusers/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8'
    },
  );
...
Future<List<User>> FetchTagusers(String text, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/tagusers/?search=${text}&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<User>.from(parsed["results"].map((x) => User.fromJSON(x)))
      : List<User>();
}

Future<Widget> FetchArticleNavg(User user, dynamic context, String id) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articles/$id/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => CommentsScreen(user: user, post: item)));
}

GotoProfile(User user, String visiteduserid, dynamic context) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicusers/$visiteduserid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  var responseJson = jsonDecode(utf8.decode(response.bodyBytes));
  Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => VisitedProfileScreen(
          user: user,
          visiteduserid: '',
          visiteduser: User.fromJSON(responseJson))));
}
...
EditUserMerchantInfo(User user, String intensity, String gatewayName,
    String gatewayMerchantId, String merchantId, String merchantName) async {
  print(user.parent);
...
Future<Widget> NavgListPublic(
    User user, String visiteduserid, dynamic context) async {
  print(visiteduserid);
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicusers/${visiteduserid}/?format=json"),
    headers: <String, String>{
  ...
  if (response.statusCode != 200) {
    NavgListFollowed(user, visiteduserid, context);
  }
  if (response.statusCode == 200) {
    var responseJson = jsonDecode(utf8.decode(response.bodyBytes));
...
Future<Widget> NavgListFollowed(
    User user, String visiteduserid, dynamic context) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/followedusers/${visiteduserid}/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  if (response.statusCode != 200) {
    NavgListPrivate(user, visiteduserid, context);
  }
  if (response.statusCode == 200) {
    var responseJson = jsonDecode(utf8.decode(response.bodyBytes));
    User item = User.fromJSON(responseJson);
...
Future<Widget> NavgListPrivate(
    User user, String visiteduserid, dynamic context) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/privateusers/${visiteduserid}/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Notifications>> FetchNotificationNew(User user, int page) async {
  ...
  if (isstandarduserdone == false) {
    final response3 = await http.get(
      Uri.parse("$SERVER_IP/api/articlecomments/?page=$page&format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    List<ArticleComment> notification3 = parsed3["results"] != null
        ? new List<ArticleComment>.from(
            parsed3["results"].map((x) => ArticleComment.fromJSON(x)))
        : List<ArticleComment>();
    for (int i = 0; i < notification3.length; i++) {
      final DateTime tempDate = new DateFormat("yyyy-MM-ddThh:mm:ss")
          .parse(notification3[i].timestamp);
      Notifications a1 = Notifications(
          timestamp: tempDate,
          id: notification3[i].id,
          author: notification3[i].authorstring,
          article: notification3[i].article,
          type: 'ArticleComment');
      finalnotifications.add(a1);
    }

    final response4 = await http.get(
      Uri.parse("$SERVER_IP/api/usercomments/?page=$page&format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    List<UserComment> notification4 = parsed4["results"] != null
        ? new List<UserComment>.from(
            parsed4["results"].map((x) => UserComment.fromJSON(x)))
        : List<UserComment>();

    for (int i = 0; i < notification4.length; i++) {
      final DateTime tempDate = new DateFormat("yyyy-MM-ddThh:mm:ss")
          .parse(notification4[i].timestamp);
      Notifications a1 = Notifications(
          timestamp: tempDate,
          id: notification4[i].id,
          author: notification4[i].author,
          profile: notification4[i].profile,
          type: 'UserComment');
      finalnotifications.add(a1);
    }

    final response10 = await http.get(
      Uri.parse("$SERVER_IP/api/usertaggedarticles/?page=$page&format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    List<ArticleTaggedUser> notification10 = parsed10["results"] != null
        ? new List<ArticleTaggedUser>.from(
            parsed10["results"].map((x) => ArticleTaggedUser.fromJSON(x)))
        : List<ArticleTaggedUser>();

    for (int i = 0; i < notification10.length; i++) {
      final DateTime tempDate = new DateFormat("yyyy-MM-ddThh:mm:ss")
          .parse(notification10[i].timestamp);
      Notifications a1 = Notifications(
          timestamp: tempDate,
          id: notification10[i].id,
          author: notification10[i].author,
          article: notification10[i].article,
          type: 'UserTaggedArticle');
      finalnotifications.add(a1);
    }

    final response9 = await http.get(
      Uri.parse("$SERVER_IP/api/requests/?page=$page&format=json"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=utf-8',
        "Authorization": "Token ${globaltoken}"
      },
    ...
    List<RequestInit> notification9 = parsed9["results"] != null
        ? new List<RequestInit>.from(
            parsed9["results"].map((x) => RequestInit.fromJSON(x)))
        : List<RequestInit>();
    for (int i = 0; i < notification9.length; i++) {
      final DateTime tempDate = new DateFormat("yyyy-MM-ddThh:mm:ss")
          .parse(notification9[i].timestamp);
      Notifications a1 = Notifications(
        timestamp: tempDate,
        ...
        link: notification9[i].link,
        contactno: notification9[i].contactno,
        ...
        type: 'Request',
        item: notification9[i].item,
        time: notification9[i].time,
        date: notification9[i].date,
        service: notification9[i].service,
        requesttype: notification9[i].requesttype,
        clientnow: notification9[i].clientnow,
        isdenied: notification9[i].isdenied,
        images: notification9[i].images,
        forms: notification9[i].forms,
        checkboxes: notification9[i].checkboxes,
        isaccepted: notification9[i].isaccepted,
...
bool checklocationvalidity(String country, String state, String city) {
  if (locationcountrygl == '-') {
    return true;
  }
  if (locationcountrygl == '') {
    return true;
  }
  if (country != locationcountrygl) {
    return false;
  }
...
Future<List<CartItem>> FetchCartItems(int page) async {
  final response2 = await http.get(
    Uri.parse("$SERVER_IP/api/cartitems/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  return parsed2["results"] != null
      ? new List<CartItem>.from(
          parsed2["results"].map((x) => CartItem.fromJSON(x)))
      : List<CartItem>();
}

Future<List<Article>> FetchArticles(int page) async {
  final response2 = await http.get(
    Uri.parse("$SERVER_IP/api/articles/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  return parsed2["results"] != null
      ? new List<Article>.from(
          parsed2["results"].map((x) => Article.fromJSON(x)))
      : List<Article>();
}

Future<List<ReservationDeactivationMonth>>
    FetchOwnReservationDeactivationMonths(int page) async {
  final response2 = await http.get(
    Uri.parse("$SERVER_IP/api/reservationdeactivationmonths/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  return parsed2["results"] != null
      ? new List<ReservationDeactivationMonth>.from(parsed2["results"]
          .map((x) => ReservationDeactivationMonth.fromJSON(x)))
      : List<ReservationDeactivationMonth>();
}
...
Future<List<CalendarSchedule>> FetchOwnCalendarSchedules(int page) async {
  final response2 = await http.get(
    Uri.parse("$SERVER_IP/api/calendarschedules/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  return parsed2
      .map<CalendarSchedule>((json) => CalendarSchedule.fromJSON(json))
      .toList();
}
...
SearchUsers(int page) async {
  ...
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicusers/?page=$page&search=&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<User> users = parsed["results"] != null
      ? new List<User>.from(parsed["results"].map((x) => User.fromJSON(x)))
      : List<User>();
...
SearchUsersNew2(int page, String searchfield, List<String> tags, bool tagsearch,
    bool searchbasedonlocation) async {
  List<User> usersfinal = [];
  if (tagsearch) {
    searchfield = newtags(tags);
  }

  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicusers/?page=$page&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final response2 = await http.get(
    Uri.parse(
        "$SERVER_IP/api/privateusers/?page=$page&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  List<User> users2 = parsed2["results"] != null
      ? new List<User>.from(parsed2["results"].map((x) => User.fromJSON(x)))
      : List<User>();
  ...
  if (searchbasedonlocation) {
    for (int i = 0; i < usersfinal.length; i++) {
      if (checklocationvalidity(usersfinal[i].locationcountry,
              usersfinal[i].locationstate, usersfinal[i].locationcity) ==
          false) {
        usersfinal.removeAt(i);
        break;
      }
    }
  }
      ...
      for (int i3 = 0; i3 < days.length; i3++) {
        if (days[i3] == searchday) {
          List<String> inititems =
              calendarowner.calendarstatuses[i].items.split(',');
...
SearchArticlesNew2(
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticles/?page=$page&type=$type&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<Article> users = parsed["results"] != null
      ? new List<Article>.from(
          parsed["results"].map((x) => Article.fromJSON(x)))
      : List<Article>();
  final response2 = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articles/?page=$page&type=$type&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  List<Article> users2 = parsed2["results"] != null
      ? new List<Article>.from(
          parsed2["results"].map((x) => Article.fromJSON(x)))
      : List<Article>();
...
SearchArticlesInProfile(
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticles/?page=$page&type=$type&author=$author&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final response2 = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articles/?page=$page&type=$type&author=$author&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  for (int i = 0; i < articlesfinal.length; i++) {
    if (searchbasedonlocation) {
      if (checklocationvalidity(articlesfinal[i].locationcountry,
              articlesfinal[i].locationstate, articlesfinal[i].locationcity) ==
          false) {
        articlesfinal.removeAt(i);
        break;
      }
    }

    if (articlesfinal[i].author != author) {
      articlesfinal.removeAt(i);
      break;
    }
    if (checklocationvalidity(articlesfinal[i].locationcountry,
    ...
    if (priceactivated) {
      if (articlesfinal[i].price > ph) {
        articlesfinal.removeAt(i);
        break;
      }
      if (articlesfinal[i].price < pl) {
        articlesfinal.removeAt(i);
        break;
      }
    }
...
Future<List<ArticleComment>> FetchOwnArticleComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlecomments/?article=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  return parsed["results"] != null
      ? new List<ArticleComment>.from(
          parsed["results"].map((x) => ArticleComment.fromJSON(x)))
      : List<ArticleComment>();
}

Future<List<UserComment>> FetchOwnUserComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/usercomments/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  return parsed["results"] != null
      ? new List<UserComment>.from(
          parsed["results"].map((x) => UserComment.fromJSON(x)))
      : List<UserComment>();
}

Future<List<ArticleComment>> FetchOwnFollowedArticleComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedarticlecomments/?article=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<ArticleComment>> FetchPublicArticleComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticlecomments/?article=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserComment>> FetchFollowedUserComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedusercomments/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserComment>> FetchPublicUserComments(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicusercomments/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserFollow>> FetchUserFollowings(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/userfollowings/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<UserFollow>.from(
          parsed["results"].map((x) => UserFollow.fromJSON(x)))
      : List<UserFollow>();
}

Future<List<UserFollow>> FetchUserFolloweds(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/userfolloweds/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Article>> FetchVisitedProfileFollowedArticles(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articles/?search=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<Article> articles = parsed["results"] != null
      ? new List<Article>.from(
          parsed["results"].map((x) => Article.fromJSON(x)))
      : List<Article>();
  return articles;
...
Future<List<Article>> FetchVisitedProfilePublicArticles(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticles/?search=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserFollow>> FetchFollowedUserFollowings(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedfollowings/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserFollow>> FetchFollowedUserFolloweds(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedfolloweds/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserFollow>> FetchPublicUserFolloweds(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicfolloweds/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserFollow>> FetchPublicUserFollowings(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicfollowings/?profile=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
bool doesitembelongtocal(
    String calendaritem, User calendarowner, String mnyinit, String day) {
  print(calendaritem);
  print(day);
  for (int i = 0; i < calendarowner.calendarstatuses.length; i++) {
    String mny = calendarowner.calendarstatuses[i].dates.substring(0, 7);
...
Future<List<CalendarTime>> FetchFollowedCalendarTime(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedcalendartimes/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<CalendarTime> times = parsed["results"] != null
      ? new List<CalendarTime>.from(
          parsed["results"].map((x) => CalendarTime.fromJSON(x)))
      : List<CalendarTime>();
  return times;
}

Future<List<CalendarTime>> FetchPublicCalendarTime(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publiccalendartimes/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<CalendarTime>> FetchOwnCalendarTime(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/calendartimes/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<CalendarStatus>> FetchOwnCalendarStatus(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/calendarstatuses/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserBookmark>> FetchOwnBookmark(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articlebookmarks/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<UserBookmark>.from(
          parsed["results"].map((x) => UserBookmark.fromJSON(x)))
      : List<UserBookmark>();
}

Future<List<UserBlock>> FetchOwnBlockedUsers(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/userblocks/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<UserBlock>.from(
          parsed["results"].map((x) => UserBlock.fromJSON(x)))
      : List<UserBlock>();
}

Future<List<UserPhone>> FetchFollowedUserPhone(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followeduserphones/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserPhone> phones = parsed["results"] != null
      ? new List<UserPhone>.from(
          parsed["results"].map((x) => UserPhone.fromJSON(x)))
      : List<UserPhone>();
...
Future<List<UserPhone>> FetchPublicUserPhone(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicuserphones/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserPhone>> FetchOwnUserPhone(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/userphones/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserMail>> FetchFollowedUserMail(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedusermails/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<UserMail>.from(
          parsed["results"].map((x) => UserMail.fromJSON(x)))
      : List<UserMail>();
}

Future<List<UserMail>> FetchPublicUserMail(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicusermails/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserMail>> FetchOwnUserMail(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/usermails/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserLocation>> FetchFollowedUserLocation(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followeduserlocations/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<UserLocation>.from(
          parsed["results"].map((x) => UserLocation.fromJSON(x)))
      : List<UserLocation>();
}

Future<List<UserLocation>> FetchPublicUserLocation(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicuserlocations/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<UserLocation>> FetchOwnUserLocation(
    http.Client client, String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/userlocations/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Article>> FetchOwnArticlesAll(
  String userid,
  int page,
  User calendarowner,
  bool typetwo,
  ...
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/fetcharticles/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<Article> finalarticles = parsed["results"] != null
      ? new List<Article>.from(
          parsed["results"].map((x) => Article.fromJSON(x)))
      : List<Article>();
  for (int i = 0; i < finalarticles.length; i++) {
    print(finalarticles[i].type);
    if (finalarticles[i].hideifoutofstock && finalarticles[i].stock > 1) {
      finalarticles.removeAt(i);
    }
    if (finalarticles[i].type == 'CI' ||
        finalarticles[i].type == 'CalendarItem') {
      if (typetwo == false) {
        if (doesitembelongtocal(
                finalarticles[i].caption, calendarowner, mnyinit, day) ==
            false) {
          finalarticles.removeAt(i);
        }
      }
    }
    if (finalarticles[i].type == 'CE' ||
        finalarticles[i].type == 'CalendarEvent') {
      if (dayfull != '' && dayfull != finalarticles[i].date) {
        finalarticles.removeAt(i);
      }
    }
  }
...
Future<List<Article>> FetchOwnArticles(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
...
Future<List<Article>> FetchOwnArticlesFiltered(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/fetcharticles/?page=$page&type=$type&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Article>> FetchFollowedArticles(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
  ...
  print('a');
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articles/?page=$page&type=$type&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  for (int i = 0; i < finalarticles.length; i++) {
    ...
    isarticleliked(userid, finalarticles[i].id)
      ..then((result) {
        finalarticles[i].likeresult = result;
      });
    isarticledisliked(userid, finalarticles[i].id)
      ..then((result) {
        finalarticles[i].dislikeresult = result;
      });
    isarticlebookmarked(userid, finalarticles[i].id)
      ..then((result) {
        finalarticles[i].bookmarkresult = result;
      });
    articlebookmarkid(userid, finalarticles[i].id)
      ..then((result) {
        finalarticles[i].bookmarkidresult = result;
      });
  }
...
Future<List<Article>> FetchPublicArticles(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticles/?page=$page&type=$type&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<Article>> FetchFollowedArticlesFiltered(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
...
Future<List<Article>> FetchPublicArticlesFiltered(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
...
Future<List<Article>> FetchFollowedArticlesAll(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
...
Future<List<Article>> FetchPublicArticlesAll(
    String userid,
    int page,
    User calendarowner,
    bool typetwo,
    ...
    String dayfull) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicarticles/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<bool> isuserliked(String authorid, String profileid) async {
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/userunlikes/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserLike> users = parsed["results"] != null
      ? new List<UserLike>.from(
          parsed["results"].map((x) => UserLike.fromJSON(x)))
      : List<UserLike>();
  if (users.isNotEmpty) {
...
Future<bool> isuserdisliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/userundislikes/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserDislike> users = parsed["results"] != null
      ? new List<UserDislike>.from(
          parsed["results"].map((x) => UserDislike.fromJSON(x)))
      : List<UserDislike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.profile) {
      return true;
    }
  }
  return false;
...
Future<bool> isarticleliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articleunlikes/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  print('aa : $parsed');
  List<ArticleLike> users = parsed["results"] != null
      ? new List<ArticleLike>.from(
          parsed["results"].map((x) => ArticleLike.fromJSON(x)))
      : List<ArticleLike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.article) {
      return true;
    }
  }
  return false;
...
Future<bool> isarticledisliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articleundislikes/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<ArticleDislike> users = parsed["results"] != null
      ? new List<ArticleDislike>.from(
          parsed["results"].map((x) => ArticleDislike.fromJSON(x)))
      : List<ArticleDislike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.article) {
...
Future<bool> isuserfollowedsilently(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/userfollows/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserFollow> users = parsed["results"] != null
      ? new List<UserFollow>.from(
          parsed["results"].map((x) => UserFollow.fromJSON(x)))
      : List<UserFollow>();
  ...
  if (users.isNotEmpty) {
    ...
    if (authorid == users.first.author &&
        profileid == users.first.profile &&
        users.first.issilent) {
      return true;
    }
  }
  return false;
...
Future<bool> isuserfollowrequested(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/requests/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<RequestInit> users = parsed["results"] != null
      ? new List<RequestInit>.from(
          parsed["results"].map((x) => RequestInit.fromJSON(x)))
      : List<RequestInit>();
  if (users.isNotEmpty) {
    if (authorid == users.first.author && profileid == users.first.profile) {
...
Future<bool> isarticlebookmarked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlebookmarks/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserBookmark> users = parsed["results"] != null
      ? new List<UserBookmark>.from(
          parsed["results"].map((x) => UserBookmark.fromJSON(x)))
      : List<UserBookmark>();
  if (users.isNotEmpty) {
...
Future<String> articlebookmarkid(String authorid, String profileid) async {
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlebookmarks/?article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<bool> isusercommentliked(String authorid, String profileid) async {
  print(
      "$SERVER_IP/api/usercommentunlikes/?author=$authorid&profile=$profileid");
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/usercommentunlikes/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserCommentLike> users = parsed["results"] != null
      ? new List<UserCommentLike>.from(
          parsed["results"].map((x) => UserCommentLike.fromJSON(x)))
      : List<UserCommentLike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.author && profileid == users.first.profile) {
      return true;
    }
...
Future<bool> isusercommentdisliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/usercommentundislikes/?author=$authorid&profile=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<UserCommentDislike> users = parsed["results"] != null
      ? new List<UserCommentDislike>.from(
          parsed["results"].map((x) => UserCommentDislike.fromJSON(x)))
      : List<UserCommentDislike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.profile) {
      return true;
...
Future<bool> isarticlecommentliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlecommentunlikes/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  print('aa : $parsed');
  List<ArticleCommentLike> users = parsed["results"] != null
      ? new List<ArticleCommentLike>.from(
          parsed["results"].map((x) => ArticleCommentLike.fromJSON(x)))
      : List<ArticleCommentLike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.article) {
      return true;
...
Future<bool> isarticlecommentdisliked(String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlecommentundislikes/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  List<ArticleCommentDislike> users = parsed["results"] != null
      ? new List<ArticleCommentDislike>.from(
          parsed["results"].map((x) => ArticleCommentDislike.fromJSON(x)))
      : List<ArticleCommentDislike>();
  if (users.isNotEmpty) {
    if (authorid == users.first.authorstring &&
        profileid == users.first.article) {
      return true;
...
Future<String> articlecommentdislikeid(
    String authorid, String profileid) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/articlecommentundislikes/?author=$authorid&article=$profileid&format=json"),
    headers: <String, String>{
...
Future<String> CreateBoughtCheck(
    CartItem product,
    String author,
    String owner,
    double price,
  ...
  if (response.statusCode == 201) {
    ...
    for (int i = 0; i < product.choices.length; i++) {
      CreateBoughtItemChoice(author, productid, product.choices[i].choice,
          product.choices[i].category, product.choices[i].price);
    }
  } else {
    throw new Exception(response.body);
  }
  ...
  if (response.statusCode == 201) {
    ...
    for (int i = 0; i < product.choices.length; i++) {
      if (product.choices[i].ischosen) {
        CreateCartItemChoice(
            author,
            responseinit.substring(7, 43),
            product.choices[i].item,
            product.choices[i].category,
            int.parse(product.choices[i].price));
      }
    }
  } else {
    throw new Exception(response.body);
...
Future<User> CreateBoughtItemChoice(String author, String item, String choice,
...
Future<User> CreateCartItemChoice(String author, String item, String choice,
    String category, int price) async {
  final http.Response response = await http.post(
...
Future<User> CreateRequestItemChoice(String author, String item, String choice,
    String category, int price) async {
  final http.Response response = await http.post(
...
Future<User> CreateMeetingSchedule(User user, String author, String profile,
    String item, String date, String time) async {
  final http.Response response = await http.post(
...
Future<User> AcceptMeetingRequest(String user1, String user2,
    Notifications notif, bool clientnow, bool isdenied, bool isaccepted) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
...
Future<User> AcceptReservationRequest(String user1, String user2,
    Notifications notif, bool clientnow, bool isdenied, bool isaccepted) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
...
Future<User> AcceptReservationScheduleRequest(String user1, String user2,
    Notifications notif, bool clientnow, bool isdenied, bool isaccepted) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
...
HighlightUserProduct(User user, Article userproduct, bool highlight) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articles/${userproduct.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
Future<Article> FetchPublicArticle(http.Client client, String userid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/publicarticles/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<Article> FetchFollowedArticle(http.Client client, String userid) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articles/$userid/?format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<ArticleCategory>> FetchFollowedUserProductCategory(
    String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/followedarticlecategories/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  return parsed["results"] != null
      ? new List<ArticleCategory>.from(
          parsed["results"].map((x) => ArticleCategory.fromJSON(x)))
      : List<ArticleCategory>();
}

Future<List<ArticleCategory>> FetchPublicUserProductCategory(
    String userid, int page) async {
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/publicarticlecategories/?author=$userid&page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
Future<List<ArticleCategory>> FetchOwnUserProductCategory(
    String userid, int page) async {
  final response = await http.get(
    Uri.parse("$SERVER_IP/api/articlecategories/?page=$page&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
...
SearchUserProductCategoriesNew2(int page, String searchfield) async {
  ...
  final response = await http.get(
    Uri.parse(
        "$SERVER_IP/api/searchpublicarticlecategories/?page=$page&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed = jsonDecode(utf8.decode(response.bodyBytes));
  print(parsed);
  List<ArticleCategory> users = parsed["results"] != null
      ? new List<ArticleCategory>.from(
          parsed["results"].map((x) => ArticleCategory.fromJSON(x)))
      : List<ArticleCategory>();
  final response2 = await http.get(
    Uri.parse(
        "$SERVER_IP/api/searchfollowedarticlecategories/?page=$page&search=$searchfield&format=json"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
      "Authorization": "Token ${globaltoken}"
    },
  ...
  final parsed2 = jsonDecode(utf8.decode(response2.bodyBytes));
  List<ArticleCategory> users2 = parsed2["results"] != null
      ? new List<ArticleCategory>.from(
          parsed2["results"].map((x) => ArticleCategory.fromJSON(x)))
      : List<ArticleCategory>();
...
Future<User> CreateReservationScheduleRequest(String author, String profile,
    String item, String startdate, String enddate) async {
  final http.Response response = await http.post(
    Uri.parse("$SERVER_IP/api/requests/"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=utf-8',
...
Future<User> CreateReservationSchedule(User user, String author, String profile,
    String item, String startdate, String enddate) async {
  print('Profile : $profile');
  print('You: $author');
  final http.Response response = await http.post(
...
Future<User> CreateReservationDeactivationMonth(
    String author, String startdate, String enddate) async {
  final http.Response response = await http.post(
...
CreateArticle(
    ...
    String enddate,
    String readtime,
    String deliveredfromtime,
    String deliveredtotime,
  ...
  try {
    FormData formData = new FormData.fromMap({
      ...
      'bathrooms': bathrooms,
      'productcondition':
          isstringnull(productcondition) ? '-' : productcondition,
      'time': '-',
      'date': '-',
    });
...
// bool
    ...
    Response response = await Dio().post("$SERVER_IP/api/articlecreate/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
    ...
    for (int i = 0; i < detailcategories.length; i++) {
      ...
      for (int j = 0; j < detailcategories[i].detailspecs.length; j++) {
        CreateArticleDetailSpec(articleid, detailcategories[i].item.text,
            detailcategories[i].detailspecs[j].item.text);
      }
    }
    ...
    for (int i = 0; i < taggedusers.length; i++) {
      CreateArticleUserTags(
          user.id, articleid, taggedusers[i].id, taggedusers[i].username);
    }

    print('10');
    for (int i = 0; i < 10; i++) {
      if (tags1[i] != "") {
        CreateArticleTags(user.id, articleid, tags1[i]);
      }
    }
...
EditArticle(
  ...
  for (int i = 0; i < post1.choicecategories.length; i++) {
    for (int j = 0; j < post1.choicecategories[i].choices.length; j++) {
      CreateUserProductChoice(
          post1.id,
          post1.choicecategories[i].category,
          post1.choicecategories[i].choices[j].item.text,
          int.parse(post1.choicecategories[i].choices[j].price.text),
          false,
          false,
          0);
    }
  ...
  for (int i = 0; i < post1.detailcategories.length; i++) {
    for (int j = 0; j < post1.detailspecs.length; j++) {
      CreateArticleDetailSpec(post1.id, post1.detailcategories[i].category,
          post1.detailcategories[i].specs[j].item.text);
    }
  }
  ...
  try {
    ...
    FormData formData = new FormData.fromMap({
      'author': post1.author,
      'locationcountry': locationcountrygl == 'null'
          ? post1.locationcountry
          : locationcountrygl,
      'locationstate':
          locationstategl == 'null' ? post1.locationstate : locationstategl,
      'locationcity':
          locationcitygl == 'null' ? post1.locationcity : locationcitygl,
      'caption': caption == '' ? post1.caption : caption,
      'details': details == '' ? post1.details : details,
      'productcondition':
          productcondition == '' ? post1.productcondition : productcondition,
      'hideifoutofstock': hideifoutofstock,
      'isforstay': false,
      'isquestion': false,
      ...
      'deliveredfromtime':
          deliveredfromtime == '' ? post1.deliveredfromtime : deliveredfromtime,
      'deliveredtotime':
          deliveredtotime == '' ? post1.deliveredtotime : deliveredtotime,
      'specialinstructions': specialinstructions == ''
          ? post1.specialinstructions
          : specialinstructions,
      'guide': guide == '' ? post1.guide : guide,
      'pricecurrency':
          pricecurrency == '' ? post1.pricecurrency : pricecurrency,
      'pricetype': '-',
      'adults': adults,
      'kids': kids,
      'bedrooms': bedrooms,
    ...
    for (int i = 0; i < usertags.length; i++) {
      CreateArticleUserTags(
          post1.author, post1.id, usertags[i].id, usertags[i].username);
    }

    Response response = await Dio().patch(
        "$SERVER_IP/api/fetcharticles/${post1.id}/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
    print(response.toString());
    locationcountrygl = '';
...
CreateArticleVideo(String author, String article, File video) async {
  ...
  try {
    ...
    await Dio().post("$SERVER_IP/api/articlevideos/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
  } catch (e) {
    print(e);
...
Future<ArticleTaggedUser> CreateArticleUserTags(
    String author, String article, String profile, String username) async {
  final http.Response response = await http.post(
...
CreateArticleComment(String author, String article, String content) async {
  try {
    ...
    await Dio().post("$SERVER_IP/api/articlecomments/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
  } catch (e) {
    print(e);
...
Future<ArticleTag> CreateArticleTags(
    String author, String article, String tag) async {
  final http.Response response = await http.post(
...
Future<User> CreateArticleReport(
    String author, String article, String issue) async {
  final http.Response response = await http.post(
...
CreateUserServiceForms(String author, String article, String hint) async {
  try {
    ...
    await Dio().post("$SERVER_IP/api/articleforms/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
  } catch (e) {
    print(e);
...
CreateUserServiceCheckBox(
    String author, String userproduct, String checkbox) async {
  try {
    FormData formData = new FormData.fromMap({
      'article': userproduct,
      'hint': checkbox,
    ...
    Response response = await Dio().post("$SERVER_IP/api/articlecheckboxes/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
...
CreateUserProductChoiceCategory(
    String userproduct, ChoiceCategoryModel cat) async {
  ...
  try {
    ...
    Response response = await Dio().post(
        "$SERVER_IP/api/articlechoicecategories/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));

    for (int i = 0; i < cat.choices.length; i++) {
      int pricefinal = cat.choices[i].price.text == ''
          ? 0
          : int.parse(cat.choices[i].price.text);
      CreateUserProductChoice(userproduct, cat.title.text,
          cat.choices[i].item.text, pricefinal, false, false, 0);
    }
  } catch (e) {
    print('a1');
    print(e);
...
CreateUserProductChoice(String userproduct, String category, String item,
    int price, bool isbuyenabled, bool allowstocks, int stock) async {
  print('${userproduct} ');
  try {
    FormData formData = new FormData.fromMap({
      'category': category,
    ...
    await Dio().post("$SERVER_IP/api/articlechoices/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
  } catch (e) {
    print('a2');
...
CreateUserProductCategory(String category, String author, File image) async {
  ...
  try {
    ...
    Response response = await Dio().post("$SERVER_IP/api/articlecategories/",
        data: formData,
        options: Options(headers: {"Authorization": "Token ${globaltoken}"}));
...
EditReservationChoiceCategory(
    ArticleChoiceCategory category, bool isallchooseable) async {
  try {
    FormData formData = new FormData.fromMap({
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articlechoicecategories/${category.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditUserServiceCheckBox(
    User user, String service, ArticleCheckBox checkbox) async {
  try {
    FormData formData = new FormData.fromMap({
      'article': service,
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articlecheckboxes/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditUserServiceForm(User user, String service, ArticleForm checkbox) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articleforms/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleActivity(User user, String service, ArticleActivity checkbox) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articleactivities/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleDetailIncluded(
    User user, String service, ArticleDetailIncluded checkbox) async {
  try {
    FormData formData = new FormData.fromMap({
      'article': service,
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articledetailincludeds/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleRule(User user, String service, ArticleDetailRule checkbox) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articledetailrules/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleAmenity(User user, String service, ArticleAmenity checkbox) async {
  try {
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articleamenities/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleHighlight(
    User user, String service, ArticleHighlight checkbox) async {
  try {
    FormData formData = new FormData.fromMap({
      'article': service,
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articlehighlights/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
EditArticleLocation(
    User user, String service, ArticleTravelLocation checkbox) async {
  try {
    FormData formData = new FormData.fromMap({
      'article': service,
    ...
    Response response = await Dio().patch(
        "$SERVER_IP/api/articletravellocations/${checkbox.id}/",
        data: formData,
        options: Options(headers: {
          "Authorization": "Token ${globaltoken}"
        }) // set content-length},
...
Future<ArticleTag> CreateArticleActivity(
    String article, String activity, String starttime) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> CreateArticleHighlight(
    String article, String highlight) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> CreateArticleTravelLocation(
    String article, String location) async {
  final http.Response response = await http.post(
...
Future<String> CreateArticleDetailCategory(
    String article, String category) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> CreateArticleDetailSpec(
    String article, String category, String spec) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> CreateArticleDetailIncluded(
    String article, String included) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> CreateUserOpeningHour(
    String author,
    String weekday,
    String fromhour,
    String tohour,
    bool isalwaysopen,
    bool ispermanentlyclosed) async {
  final http.Response response = await http.post(
...
Future<ArticleTag> EditUserOpeningHour(
    UserOpeningHour uoh,
    String author,
    String weekday,
    String fromhour,
