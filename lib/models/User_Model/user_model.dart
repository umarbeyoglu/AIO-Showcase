import 'package:untitled/models/User_Model/user_bookmark_model.dart';
import 'package:untitled/models/User_Model/user_calendar_schedule_model.dart';
...
final int subusers;
  ...
  final String wifipassword;final String wifiname;final bool doublebooking;final bool appointmentapproval;
...
//List<Recommend> recommends = [];
  ...
  User({//this.recommends,
    this.openinghours,
    this.wifipassword,this.wifiname,this.doublebooking,this.appointmentapproval,this.meetingschedules,this.meetingstatuses,
    this.recentchats2,this.reservationdeactivationmonths,this.reservationschedules,this.cartitems,this.ishotel,this.hotelclass,
 this.id,this.email,this.pricerange,this.businessstatus,this.locationcountry,this.messagecount,this.locationcity,this.locationstate,this.isprofileanon,this.intensity,this.parent,this.business_type,this.likes,this.comments,this.views,this.dislikes,this.followers,this.following,this.bookmarks,this.tags,
    this.recentchats,this.relevantmessages, this.messagessent,this.messagesreceived,  this.isdetailsprivate,this.isnsfwallowed, this.isnstlallowed,this.issensitiveallowed,this.isspoilerallowed,  this.username, this.full_name,this.calendar_type,this.calendar_ismultichoice,
    this.image,this.issubusersallowed,this.phone_number, this.sign_up_date, this.last_login, this.online, this.public_profile, this.open_now, this.birth_date,
    this.details, this.gatewayName,this.gatewayMerchantId,this.merchantId,this.merchantName,this.profile_type,this.calendarschedules,this.calendarstatuses,this.subusers,
  });
  ...
  factory User.fromJSON(Map<String, dynamic> jsonMap) {
    ...
    appointmentapproval: jsonMap['appointmentapproval'] as bool,
      ...
      bookmarks: jsonMap["userbookmarks_set"] != null ? List<UserBookmark>.from( jsonMap["userbookmarks_set"].map((x) => UserBookmark.fromJSON(x))) : [],
      tags: jsonMap["usertags_set"] != null ? List<UserTag>.from( jsonMap["usertags_set"].map((x) => UserTag.fromJSON(x))) : [],
      calendarschedules: jsonMap["calendarschedules_set"] != null ? List<CalendarSchedule>.from( jsonMap["calendarschedules_set"].map((x) => CalendarSchedule.fromJSON(x))) : [],
      calendarstatuses: jsonMap["calendarstatuses_set"] != null ? List<CalendarStatus>.from( jsonMap["calendarstatuses_set"].map((x) => CalendarStatus.fromJSON(x))) : [],
      messagessent: jsonMap["usermessages_set"] != null ? List<Message>.from( jsonMap["usermessages_set"].map((x) => Message.fromJSON(x))) : [],
      messagesreceived: jsonMap["usermessages"] != null ? List<Message>.from( jsonMap["usermessages"].map((x) => Message.fromJSON(x))) : [],
      reservationdeactivationmonths: jsonMap["reservationdeactivationmonths_set"] != null ? List<ReservationDeactivationMonth>.from( jsonMap["reservationdeactivationmonths_set"].map((x) => ReservationDeactivationMonth.fromJSON(x))) : [],
      reservationschedules: jsonMap["reservationschedules_set"] != null ? List<ReservationSchedule>.from( jsonMap["reservationschedules_set"].map((x) => ReservationSchedule.fromJSON(x))) : [],
      meetingschedules: jsonMap["meetingschedules_set"] != null ? List<MeetingSchedule>.from( jsonMap["meetingschedules_set"].map((x) => MeetingSchedule.fromJSON(x))) : [],
      meetingstatuses: jsonMap["meetingstatuses_set"] != null ? List<MeetingStatus>.from( jsonMap["meetingstatuses_set"].map((x) => MeetingStatus.fromJSON(x))) : [],
      cartitems: jsonMap["cartitems_set"] != null ? List<CartItem>.from( jsonMap["cartitems_set"].map((x) => CartItem.fromJSON(x))) : [],
      openinghours: jsonMap["useropeninghours_set"] != null ? List<UserOpeningHour>.from( jsonMap["useropeninghours_set"].map((x) => UserOpeningHour.fromJSON(x))) : [],
  ...
  String shouldshowuserinfo(User user,bool condition){
    if(condition){return 'followed';}
    if(user.public_profile == null){return 'null';}
    if(user.public_profile){return 'public';}
    return 'null';
  }
  ...
  bool subuseratt(String parentid){
    ...
    if (isprofileanon){return false;}
    return true;
  }

  Widget intensityfuncicon2(dynamic context){
    if(intensity == 'verybusy'){
      return Text('$intensityst : $verybusyst',
    ...
    if(intensity == 'busy'){
      return Text('$intensityst : $busyst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(intensity == 'normal'){
      return Text('$intensityst : $normalst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(intensity == 'idle'){
      return Text('$intensityst : $idlest',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(intensity == 'quiet'){
      return Text('$intensityst : $quietst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
  ...
  Widget pricerangefuncicon2(dynamic context){
    ...
    if(pricerange == 'premium'){
      return Text('$pricerangest : $premiumst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(pricerange == 'high'){
      return Text('$pricerangest : $highst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(pricerange == 'standard'){
      return Text('$pricerangest : $standardst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(pricerange == 'low'){
      return Text('$pricerangest : $lowst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
  ...
  Widget businessstatusfuncicon2(dynamic context){
    ...
    if(businessstatus == 'oas'){
      return Text('$businessstatusst : $operatingasusualst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(businessstatus == 'sc'){
      return Text('$businessstatusst : $underservicechangesst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(businessstatus == 'tc'){
      return Text('$businessstatusst : $temporarilyclosedst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
    ...
    if(businessstatus == 'fc'){
      return Text('$businessstatusst : $permanentlyclosedst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
  ...
  Widget intensityfuncicon(dynamic context){
    ...
    return Text('$intensityst : $unspecifiedst',
      style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
          .of(context)
          .size
          .height * 0.026,),
  ...
  Widget pricerangefuncicon(dynamic context){
    ...
    return Text('$pricerangest : $unspecifiedst',
      style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
          .of(context)
          .size
          .height * 0.026,),
  ...
  Widget businessstatusfuncicon(dynamic context){
    ...
    if(businessstatus == ''){
      return Text('$businessstatusst : $unspecifiedst',
        style: TextStyle( color: colordtmaintwo,fontWeight: FontWeight.bold, fontSize: MediaQuery
            .of(context)
            .size
            .height * 0.026,),
  ...
  bool isfollowedprofile(User visiteduser,User user,bool followed2,bool unfollowed,bool condition1,bool condition2) {
    bool isfollowed = false;

    if (followed2 == true) {return true;}
    if (unfollowed == true) {return false;}
  ...
  bool ismaderequestfunc(User user,User visiteduser,bool condition1,String condition2){
    if(ismaderequest){
      return true;
    }
  ...
  bool islikedprofile(User visiteduser,User user,bool liked2,bool unliked,bool condition) {
    print('lr : $likeresult');
    bool isliked = false;
    if (liked2 ) {return true;}
    if (unliked&& likeresult == false) {return false;}
  ...
  bool isdislikedprofile(User visiteduser,User user,bool disliked2,bool undisliked,bool condition) {
    bool isliked = false;
...
class UserMC {
  ...
  //api&device token
  UserMC({
    this.id,this.messagecount,this.messagecount2});
