...
String firsttimeaboutexpst = languagest == 'EN'
    ? 'Tell people something about you. People will read it when they'
        'enter your profile'
    : 'İnsanlara kendiniz'
        'hakkında birşeylerden bahsedin.Profilinizi ziyaret ettiklerinde bu yazıyı okuyacaklardır.';

String firsttimehotelinfoexpst = languagest == 'EN'
    ? 'Enter your class and tick the box if this account is for your hotel'
    : '.';
String firsttimeaboutbsexpst = languagest == 'EN'
    ? 'Tell people something about your business. People will read it when they'
        'enter your profile'
    : 'İnsanlara işletmeniz'
        'hakkında birşeylerden bahsedin.Profilinizi ziyaret ettiklerinde bu yazıyı okuyacaklardır.';

String firsttimecalendarexpst = languagest == 'EN'
    ? 'Choose your calendar type so you can announce what you are'
        'up to in certain dates,so you can set appointments with clients'
    : 'Takvim çeşidinizi seçin. Seçtiğinizde yapacağınız etkinlikleri'
        'gösterebilir veya müşterilerinizle randevu alabilirsiniz';
String firsttimeimageexpst = languagest == 'EN'
    ? 'Create a Profile Picture so other people can identify you'
    : 'Profil resmi eklemeniz insanlar sizi tanımasına yardımcı olur.';

String firsttimeimagebsexpst = languagest == 'EN'
    ? 'Create a Profile Picture so other people can identify your business'
    : 'Profil resmi eklemeniz insanlar işletmenizi tanımasına yardımcı olur.';

String firsttimenameexpst = languagest == 'EN'
    ? 'Enter your name so people can identify you'
    : ''
        'Sizin ismini girin ki insanlar sizi tanıyabilsin';
String firsttimenamebsexpst = languagest == 'EN'
    ? 'Enter your business name so people can identify your business'
    : ''
        'İşletmenizin ismini girin ki insanlar işletmenizi tanıyabilsin';

String firsttimelocationexpst = languagest == 'EN'
    ? 'Use location so you can be more relevant when'
        'people search for your profile'
    : 'Konum kullanmanız kullancılar profilinizi ararken sizi gösterme sıklığı artar.';

String firsttimewifiexpst = languagest == 'EN'
    ? 'Enter wifi information so clients can use your wifi.'
        ''
    : 'Wifi bilgilerinizi girerseniz kullanıcılar internetinize erişebilir.';

String firsttimecreditcardinfoexpst = languagest == 'EN'
    ? 'Upload your credit card info so we can send you payments'
    : 'Kredi kartı bilgilerinizi girin ki size ödemeleri gönderebilelim';

String firsttimephoneexpst = languagest == 'EN'
    ? 'Enter your Whatsapp Number so people that visit your profile'
        'can contact you from Whatsapp'
    : 'Whatsapp numaranızı girerseniz kullanıcılar profilinize girdiğinde siz Whatsapptan ulaşabilir';
String firsttimepricerangeexpst = languagest == 'EN'
    ? 'Choose your price range so people can expect costs of'
        'choosing your business'
    : 'Fiyat aralığınızı seçin ki insanlar sizin işletmenizi kullanmadan önce maliyetinizi bilsinler';
String firsttimepublicprofileexpst = languagest == 'EN'
    ? 'Is your profile going to be open for view by everyone?'
    : 'Profiliniz herkese açık mı olacak?';
String firsttimetagsexpst = languagest == 'EN'
    ? 'Add some tags to distinct your profile'
    : 'Profilinizi farklılaştırmak için tag ekleyiniz';
String articlelikest =
    languagest == 'EN' ? 'liked your article' : 'postunuzu beğendi';
String articlecommentst =
    languagest == 'EN' ? 'commented on your article' : 'postunuza yorum yaptı';
String usercommentst = languagest == 'EN'
    ? 'commented on your profile'
    : 'profilinize yorum yaptı';
String allchooseablest =
    languagest == 'EN' ? 'All Chooseable' : 'Hepsi Seçilebilir';
String calendaritemcommentst = languagest == 'EN'
    ? 'commented on your calendar item'
    : 'takvim ürününüze yorum yaptı';
String calendareventcommentst = languagest == 'EN'
    ? 'commented on your calendar event'
    : 'takvim etkinliğinize yorum yaptı';
String userproductcommentst = languagest == 'EN'
    ? 'commented on your user product'
    : 'kullanıcı ürününüze yorum yaptı';
String userservicecommentst = languagest == 'EN'
    ? 'commented on your user service'
    : 'kullanıcı servisinize yorum yaptı';
String articleusertagst =
    languagest == 'EN' ? 'tagged you in an article' : 'postta sizi etiketledi';
...
String removefromlistst =
    languagest == 'EN' ? 'Remove From List' : 'Listeden Çıkar';
...
String deliveryoptionst =
    languagest == 'EN' ? 'Food Delivery Option' : 'Yemek Teslim Tipi';
String reservationcommentst =
    languagest == 'EN' ? 'Reservation Comment' : 'Rezervasyon Yorumu';
String reservationsst = languagest == 'EN' ? 'Reservations' : 'Rezervasyonlar';
String addreservationsst =
    languagest == 'EN' ? 'Add Reservation' : 'Rezervasyon ekle';
String firsttimebusinessst =
    languagest == 'EN' ? 'Business Type' : 'İşletme Tipi';
...
String daysareunavailablest =
    languagest == 'EN' ? 'Days are Unavailable!' : 'Günler Uygun Değil!';
String firsttimebusinessexpst = languagest == 'EN'
    ? 'If your business is considered as one of these types,please choose it'
    : 'Eğer işletmeniz bu şıklardan birine uyuyorsa lütfen seçiniz';
...
String meetingstatuswarningst = languagest == 'EN'
    ? 'Deleting them wont affect any schedule or requests'
    : "Saatleri silmenin randevu ve isteklere bir etkisi olmayacaktır";

String deniedmeetingrequestst = languagest == 'EN'
    ? 'Denied meeting request'
    : 'Toplantı isteğini reddetti';
String acceptedmeetingrequestst = languagest == 'EN'
    ? 'Accepted meeting request'
    : 'Toplantı isteğini kabul etti';
String sentmeetingdetailsst = languagest == 'EN'
    ? 'Sent meeting details'
    : 'Toplantı detaylarını gönderdi';
String sentmeetingrequestst =
    languagest == 'EN' ? 'Sent meeting request' : 'Toplantı isteği gönderdi';
String sendmeetingrequestst =
    languagest == 'EN' ? 'Send meeting request' : 'Toplantı isteği gönder';
...
String doyouwanttodeletethisst = languagest == 'EN'
    ? 'Do you want to delete this?'
    : 'Bu öğeyi silmek istiyor musunuz?';
String appointmentstypest =
    languagest == 'EN' ? 'Appointment Type' : 'Randevu Tipi';
String appointmentsettingsst =
    languagest == 'EN' ? 'Appointment Settings' : 'Randevu Ayarları';
String takenappointmentsst =
    languagest == 'EN' ? 'Created Appointments' : 'Alınmış Randevular';
...
String clientprofilest =
    languagest == 'EN' ? 'Client Profile' : 'Müşteri Profili';
String itemdetailsst = languagest == 'EN' ? 'Item Details' : 'Ürün Detayları';
String editmerchantinfost = languagest == 'EN'
    ? 'Edit Merchant Information'
    : 'Tüccar Bilgisini Düzenle';
String firsttimecreditcardinfost =
    languagest == 'EN' ? 'Credit Card Information' : 'Kredi Kartı bilgisi';
...
String specialrequestst = languagest == 'EN'
    ? 'Special Request (Optional)'
    : 'Ekstra İstek (İsteğe bağlı)';
String boughtanitemst =
    languagest == 'EN' ? 'bought an item' : 'ürün satın aldı';
String isbuyenabledst =
    languagest == 'EN' ? 'Enable Buy Option' : 'Satın Almayı Etkinleştir';
String areyouincyprusst = languagest == 'EN'
    ? 'Are you in living in Cyprus?'
...
String operatingasusualst =
    languagest == 'EN' ? 'Operating Usually' : 'Her zamanki gibi işliyor';
String underservicechangesst = languagest == 'EN'
    ? 'Under Service Changes'
    : 'Servis değişiklikleri altında';
String temporarilyclosedst =
    languagest == 'EN' ? 'Temporarily closed' : 'Geçici olarak kapalı';
String permanentlyclosedst =
    languagest == 'EN' ? 'Permanently closed' : 'Kalıcı olarak kapalı';
String businessstatusst =
    languagest == 'EN' ? 'Business Status' : "İşletme Durumu";
...
String productconditionst =
    languagest == 'EN' ? 'Product Condition' : 'Ürün durumu';
...
String firsttimecalendarst =
    languagest == 'EN' ? 'Setup Your Calendar' : 'Takviminizi Ayarlayın';
String firsttimeimagest =
    languagest == 'EN' ? 'Upload an Image' : 'Resminizi Yükleyin';
String firsttimenamest =
    languagest == 'EN' ? 'Enter Your Name' : 'İsminizi Yükleyin';
String firsttimephonest = languagest == 'EN'
    ? 'Enter Your Whatsapp Number'
    : 'Whatsapp Numaranızı Yükleyin';
String firsttimelocationst =
    languagest == 'EN' ? 'Enter Your Location' : 'Konumunuzu Girin';
String firsttimepricerangest =
    languagest == 'EN' ? 'Enter Your Price Range' : 'Fiyat Aralığınızı Girin';
String firsttimepublicprofilest = languagest == 'EN'
    ? 'Is Your Profile Public?'
    : 'Profiliniz Genele Açık mı?';
String firsttimetagsst =
    languagest == 'EN' ? 'Enter Your Tags' : 'Taglarınızı Girin';
String mailsst = languagest == 'EN' ? 'Contact Mails' : 'İletişim Mailleri';
String clientst = languagest == 'EN' ? 'Client' : 'Müşteri';
String phonesst =
    languagest == 'EN' ? 'Contact Phones' : 'İletişim Telefonları';
String locationsst =
    languagest == 'EN' ? 'Contact Locations' : 'İletişim Konumları';
String requestedfollowingservicest = languagest == 'EN'
    ? 'Requested Following Service'
    : "şu servis için istekte bulundu";
...
String deniedyourservicest = languagest == 'EN'
    ? 'Denied your service request'
    : "Servis isteğinizi reddetti";
String acceptedyourservicest = languagest == 'EN'
    ? 'Accepted your service request'
    : "Servis isteğinizi kabul etti";
String explanationst = languagest == 'EN' ? 'Explanation' : "Açıklama";
String choosedatesst = languagest == 'EN' ? 'Choose dates' : "";
String calendarstatusexpst = languagest == 'EN'
    ? 'Create Status so your clients will choose from specified date&time'
    : "";
String extendedfiltersst =
    languagest == 'EN' ? 'Extended Filters' : "Gelişmiş Filtreleme";
String explanationforacceptordenyst = languagest == 'EN'
    ? 'Explanation for Accepting/Denying'
    : "Kabul/Reddetme için Açıklama";
String servicenamest = languagest == 'EN' ? 'Service Name' : "Servis İsmi";
String userservicecategoriesst = languagest == 'EN'
    ? 'User Service Categories'
    : "Kullanıcı Servis Kategorileri";
String formcategoriesst =
    languagest == 'EN' ? 'Form Categories' : "Form Kategorileri";
String productcategoriesst =
    languagest == 'EN' ? 'Product Categories' : "Ürün Kategorileri";
String requireimagesst = languagest == 'EN'
    ? 'Require Images option'
    : "Gerekli Fotoğraflar seçeneği";
...
String calendarschedulesst =
    languagest == 'EN' ? 'Calendar Schedules' : "Takvim Randevuları";
String publicst = languagest == 'EN' ? 'Public' : "Erişime Açık";
String darklightthemest = languagest == 'EN'
    ? 'Change Dark/Light Theme '
    : "Parlak/Karanlık Temayı Değiştir ";
String requestedfollowingproductst = languagest == 'EN'
    ? 'Requested Following Product:'
    : "Aşağıdaki Ürünü Talep Etti:";
...
String isprofileanonst =
    languagest == 'EN' ? 'Is Sub-user Private?' : "Alt-kullanıcı gizli mi?";
...
String nothingtoseeherest =
    languagest == 'EN' ? 'Nothing to see here' : "Görülecek birşey yok";
...
String removefromgroupst =
    languagest == 'EN' ? 'Remove From Group' : "Gruptan Çıkar";
...
String noissueenteredst =
    languagest == 'EN' ? 'No Issue Entered' : "Sorun girilmedi";
...
String productsandformsst =
    languagest == 'EN' ? 'Products and Services' : "Ürünler ve Servisler";
String choosegroupst = languagest == 'EN' ? 'Choose Group' : "Grup Seç";
String groupsst = languagest == 'EN' ? 'Groups' : "Gruplar";
String timestatusexpst =
    languagest == 'EN' ? 'Add times you want inside status here' : "";
String subusersst = languagest == 'EN' ? 'Sub users' : "Alt kullanıcılar";
String nonameenteredst =
    languagest == 'EN' ? 'No Name Entered' : "İsim girilmedi";
...
String eypasswordst =
    languagest == 'EN' ? 'Enter your password' : "Şifrenizi girin";
String validpsst =
    languagest == 'EN' ? 'Must be at least 6 characters' : "6 Karakter gerekli";
String validps2st =
    languagest == 'EN' ? 'Please enter a password' : "Lütfen şifrenizi girin";
String loginst = languagest == 'EN' ? 'Login' : "Giriş yap";
String emailerrorst = languagest == 'EN'
    ? 'Please enter your email correctly'
    : "Lütfen emailinizi doğru girin";
String emailerror2st = languagest == 'EN'
    ? 'Please enter a valid email'
    : "Lütfen geçerli bir email girin";
String imageerrorst =
    languagest == 'EN' ? 'Please insert your image' : "Lütfen resim giriniz";
String locationerrorst = languagest == 'EN'
    ? 'Please enter your location'
    : "Lütfen konumunuzu girin";
String phonenumbererrorst = languagest == 'EN'
    ? 'Please enter your phone number'
    : "Lütfen telefon numaranızı girin";
String passworderrorst = languagest == 'EN'
    ? 'Please enter your password correctly'
    : "Lütfen şifrenizi doğru girin";
String inputerrorst = languagest == 'EN'
    ? 'Please check your input and try again'
    : "Lütfen girdiklerinizi kontrol edip tekrar deneyin";
String postcreatesuccessst = languagest == 'EN'
    ? 'Post Created!We will redirect you to homepage shortly!'
    : "Başarılı!Sizi kısa sürede yönlendireceğiz!";
String postcreateinformationst = languagest == 'EN'
    ? 'Please wait for the pictures to upload..'
    : "Lütfen resimlerin yüklenmesini bekleyin..";
...
String validemailst = languagest == 'EN'
    ? 'Please enter a valid email'
    : "Lütfen geçerli bir mail girin";
String validusernamest = languagest == 'EN'
    ? 'Please enter a username'
    : "Lütfen bir kullanıcı adı girin";
String usernamest = languagest == 'EN' ? 'Username*' : "Kullanıcı adı*";
String eyusernamest =
    languagest == 'EN' ? 'Enter your username' : "Kullanıcı adınızı girin";
String firstnamest = languagest == 'EN' ? 'First Name' : "Ad";
String requiredinfost =
    languagest == 'EN' ? 'Required Information' : "Gerekli Bilgi";
String personalinfost =
    languagest == 'EN' ? 'Personal Information' : "Kişisel Bilgi";
String businessinfost =
    languagest == 'EN' ? 'Business Information' : "İşletme Bilgisi";
String fullnamest = languagest == 'EN' ? 'Full Name' : "Ad Soyad";
String eyfirstnamest =
    languagest == 'EN' ? 'Enter your first name' : "Adınızı girin";
String eyfullnamest =
    languagest == 'EN' ? 'Enter your full name' : "Ad,soyad girin";
String lastnamest = languagest == 'EN' ? 'Last Name' : "Soyad";
String eylastnamest =
    languagest == 'EN' ? 'Enter your last name' : "Soyadınızı girin";
...
String eyphonenost = languagest == 'EN'
    ? 'Enter your whatsapp number'
    : "Lütfen whatsapp numarası girin";
...
String eypersontagsst = languagest == 'EN'
    ? 'Tags (Split with ,) Ex:Bookworm,Social etc..'
    : "Taglar (, ile ayır) Ör:Kitapkurdur,sosyal vb..";
String eybusinesstagsst = languagest == 'EN'
    ? 'Tags (Split with ,) Ex:Car Dealer,Accounting etc...'
    : "Taglar (, ile ayır) Ör:Pet shop,muhasebeci vb..";
String signupst = languagest == 'EN' ? "Register" : "Kaydol";
String errortruest = languagest == 'EN'
    ? 'Either server is not running or there is a problem with your input'
    : "Ya server çalışmıyor ya da girdiklerinizde sorun var.";
String signupsuccessst = languagest == 'EN'
    ? 'Success!We will redirect you shortly!'
    : "Başarılı!Sizi kısa sürede yönlendireceğiz!";
String likest = languagest == 'EN' ? 'Like' : "Beğen";
String likesst = languagest == 'EN' ? 'Likes' : "Beğeniler";
String addsubusersst =
    languagest == 'EN' ? 'Add Subusers' : "Altkullanıcı Ekle";
...
String writeacommentst =
    languagest == 'EN' ? 'Write a Comment...' : "Yorum yaz...";
String writeafeedbackst =
    languagest == 'EN' ? 'Write a Feedback...' : "Geridönüş yaz...";
...
String details3st =
    languagest == 'EN' ? 'Details (Optional)' : "Detaylar (Gerekli Değil)";
...
String disablecommentsst =
    languagest == 'EN' ? 'Disable Comments' : "Yorumları devre dışı bırak";
String disablestatsst =
    languagest == 'EN' ? 'Disable Stats' : "İstatistikleri devre dışı bırak";
String nocaptionenteredst =
    languagest == 'EN' ? 'No caption entered' : "Genel yazı girilmedi";
String notagenteredst =
    languagest == 'EN' ? 'No tag entered' : "Taglar girilmedi";
String choosepicturesst = languagest == 'EN' ? 'Choose pictures' : "Resim seç";
String eyposttags2st = languagest == 'EN'
    ? "Tags (Split with ,) Ex:aio_ui,Flutter,Dart"
    : "Taglar (, ile ayır)";
...
String deletemyprofilest =
    languagest == 'EN' ? 'Yes,delete my profile' : "Evet,kullanıcıyı silin";
String gobackst = languagest == 'EN' ? 'Go Back' : "Geri git";
String edituserrefreshst = languagest == 'EN'
    ? 'Note:When you apply the changes,please click Refresh Button in feed'
    : "Not:Değişiklikleri kaydettiğinizde,lütfen ana sayfada Yenile tuşuna tıklayınız";
...
String noitemschosenst =
    languagest == 'EN' ? 'No Items Chosen' : "Ürün Seçilmedi";
String postcaptionst =
    languagest == 'EN' ? 'Post Caption' : "Post genel yazısı";
String writeotherissueherest =
    languagest == 'EN' ? 'Write issue here' : "Sorunu buraya yazın";
String postdetailsst = languagest == 'EN' ? 'Post Detail' : "Post detayları";
String blockedusersst =
    languagest == 'EN' ? 'Blocked Users' : "Engellenmiş Kullanıcılar";
String sharearticlest = languagest == 'EN' ? 'Share Article' : "Postu Paylai";
String forbusinessst =
    languagest == 'EN' ? 'For Businesses' : "İşletmeler için";
String unblockst = languagest == 'EN' ? 'Unblock' : "Engeli Kaldır";
String calendarst = languagest == 'EN' ? 'Calendar' : "Takvim";
String cancelrequestst =
    languagest == 'EN' ? 'Cancel Request' : "İsteği Kaldır";
String sendsubscriptionrequestst =
    languagest == 'EN' ? 'Send Follow Request' : "Takip İsteği Gönder";
...
String nocalendarst =
    languagest == 'EN' ? "Calendar Disabled" : 'Takvim devre dışı';
...
String schedulerequestst =
    languagest == 'EN' ? 'Schedule Request' : "Randevu İsteği";
String fullcalendarst = languagest == 'EN' ? 'All Features' : "Tüm Özellikler";
String createsubuserst =
    languagest == 'EN' ? 'Create Sub-user' : "Alt-Kullanıcı oluştur";
...
String requestsonlyst =
    languagest == 'EN' ? 'Requests Only' : "Sadece İstekler";
String chooseitemsherest =
    languagest == 'EN' ? 'Choose Items Here' : "Öğeleri buradan seç";
String reportuserst =
    languagest == 'EN' ? 'Report User' : "Kullanıcıyı Şikayet Et";
String dorequestst = languagest == 'EN' ? 'Do Request' : "İstek Gönder";
String statusscreenst = languagest == 'EN' ? 'Status Screen' : "Durum Ekranı";
String choosedatefromcalendarst =
    languagest == 'EN' ? 'Choose a day From Calendar' : "Takvimden bir gün seç";
String reporttype1st = languagest == 'EN'
    ? 'Inappropriate/Vulgar content'
    : "Uygunsuz/Kaba içerik";
String reporttype2st = languagest == 'EN' ? 'Gore Content' : "Kanlı içerik";
String reporttype3st =
    languagest == 'EN' ? 'Abusive Behaviour' : "Kötü davranış";
...
String ispromovideost =
    languagest == 'EN' ? 'Is Promotional Video' : "Promosyon Videosu mu?";
String isjobpostingst =
    languagest == 'EN' ? 'Is Job Posting' : "İş paylaşımı mı?";
String nsfwst = languagest == 'EN' ? 'NSFW' : "NSFW";
String userservicesst =
    languagest == 'EN' ? 'User Services' : "Kullanıcı Servisleri";
...
String bannedusersst =
    languagest == 'EN' ? 'Banned Users' : "Banlanmış Kullanıcılar";
...
String allownsfwst =
    languagest == 'EN' ? 'Allow NSFW' : "NSFW paylaşıma izin ver";
String allownstlst =
    languagest == 'EN' ? 'Allow NSTL' : "NSTL paylaşıma izin ver";
String allowsensitivest =
    languagest == 'EN' ? 'Allow Sensitive' : "Hassas paylaşıma izin ver";
String allowspoilerst =
    languagest == 'EN' ? 'Allow Spoiler' : "Spoiler paylaşıma izin ver";
String pickimageerrorst =
    languagest == 'EN' ? 'Pick Image Error' : "Resim alma hatası";
String pickimagevideoerrorst =
    languagest == 'EN' ? 'Pick Image/Video Error' : "Resim/Video alma hatası";
String youhavenotyetpickedavideost = languagest == 'EN'
    ? 'You have not yet picked a video'
    : "Herhangi bir video almadınız";
String youhavenotyetpickedanimageorvideost = languagest == 'EN'
    ? 'You have not yet picked  image/video'
    : "Herhangi bir video/resim almadınız";
String youhavenotyetpickedanimagest = languagest == 'EN'
    ? 'You have not yet picked an image'
    : "Herhangi bir resim almadınız";
String producttemplateest =
    languagest == 'EN' ? 'Product Template' : "Ürün şablonu";
String eventtemplateest =
    languagest == 'EN' ? 'Event Template' : "Etkinlik şablonu";
String servicetemplateest =
    languagest == 'EN' ? 'Service Template' : "Servis şablonu";
...
String addtouserproductsst =
    languagest == 'EN' ? 'Add to user products' : "Kullanıcı ürünlerine ekle";
String userproductcategoriesst = languagest == 'EN'
    ? 'User Product Categories'
    : "Kullanıcı Ürün Kategorileri";
String userproductsst =
    languagest == 'EN' ? 'User Products' : "Kullanıcı Ürünleri";
String userproducttagsst =
    languagest == 'EN' ? 'User Product Tags' : "Kullanıcı Ürün Tagları";
String deletegroupst = languagest == 'EN' ? 'Delete Group' : "Grubu Sil";
String allowcalendarst =
    languagest == 'EN' ? 'Allow Calendar' : "Takvime İzin Ver";
String allowsubusersst =
    languagest == 'EN' ? 'Allow Subusers' : "Alt Kullanıcılara İzin Ver";
String ismultipleitemchoicecalendarst = languagest == 'EN'
    ? 'Is Multiple Item Choice Allowed'
    : "Birden çok ürün seçmeye izniniz var mı?";
String addimagesst =
    languagest == 'EN' ? 'Add images here' : "Resimleri buradan ekle";
String addeventsst = languagest == 'EN' ? 'Add event' : "Etkinlik ekle";
String calendardayownschedulest = languagest == 'EN'
    ? 'Your own calendar schedules at same day'
    : "Aynı günde olan takvim randevularınız";
...
String jobapplicationsst =
    languagest == 'EN' ? 'Job Applications' : "İş Başvuruları";
...
String deniedyourrequestst =
    languagest == 'EN' ? 'Denied Your Request' : "İsteğinizi reddetti";
String acceptedyourrequestst =
    languagest == 'EN' ? 'Accepted Your Request' : "İsteğinizi kabul etti";

String descriptionst = languagest == 'EN' ? 'Description' : "Açıklama";
String chooselocationst = languagest == 'EN' ? 'Choose Location' : "Konum Seç";
String connectedbusinessesst =
    languagest == 'EN' ? 'Connected Businesses' : "Bağlı İşletmeler";
...
String chosentimesst =
    languagest == 'EN' ? 'Chosen Times' : "Seçilmiş zamanlar";
String otherst = languagest == 'EN' ? 'Other' : "Diğer";
String termsandconditionsst = languagest == 'EN'
    ? 'I am older than 13 years old and i accept Terms&Conditions'
    : "13 Yaşından büyüğüm ve Koşulları&Kuralları kabul ediyorum";
String termsandconditionserrorst = languagest == 'EN'
    ? 'Terms and Conditions are not accepted'
    : "Koşullar ve kurallar kabul edilmedi";
String emailexistsst =
    languagest == 'EN' ? 'Email Exists' : "Eposta zaten kayıtlı";
String usernameexistsst =
    languagest == 'EN' ? 'Username Exists' : "Kullanıcı adı zaten kayıtlı";
String founderandcoderst =
    languagest == 'EN' ? 'Founder and Coder' : "Kurucu ve kodlamacı";
String poweredbyflutterst =
    languagest == 'EN' ? 'Powered By Flutter' : "Flutter tarafından yapıldı";
String sentgrouprequestst = languagest == 'EN'
    ? 'Sent Group Membership Request for group :'
    : "Şu gruba üyelik isteği gönderdi";
String sentfollowrequestst =
    languagest == 'EN' ? 'Sent Follow Request' : "Takip isteği gönderdi";
String sentcalendarrequestst =
    languagest == 'EN' ? 'Sent Calendar Request' : "Takvim isteği gönderdi";
String sentreservationrequestst = languagest == 'EN'
    ? 'Sent Reservation Request'
    : "Rezervasyon isteği gönderdi";
String sentcalendardetailsst = languagest == 'EN'
    ? 'Sent Calendar Details'
    : "Takvim detaylarını gönderdi";
String deniedcalendarst = languagest == 'EN'
    ? 'denied date/time offered'
    : "önerilen zamanı/saati reddetti";
String itemst = languagest == 'EN' ? 'Item' : "Ürün";
String fromst = languagest == 'EN' ? 'From' : "Burdan";
String restauranttypest =
    languagest == 'EN' ? 'Restaurant Type' : "Restoran Tipi";
...
String enterdetailincludedtextst =
    languagest == 'EN' ? 'Enter Thing included' : "";
String adddetailincludedtextst =
    languagest == 'EN' ? 'Add things that are included' : "";
...
String entertravellocationtextst =
    languagest == 'EN' ? 'Enter Travel Location Text' : "";
String specialinstructionsst = languagest == 'EN' ? 'Special Instructions' : "";

String nopostst = languagest == 'EN'
    ? 'Follow someone to see posts here'
    : "Burada paylaşımlar görmek için birilerini takip edin";

String choosebycataloguest = languagest == 'EN'
    ? 'Search Places by Product Catalogue'
    : "İşletmeleri Ürün Kataloğu ile Ara";
String bycataloguest =
    languagest == 'EN' ? 'Product Catalogue' : "Ürün Kataloğu";
...
String chooserestauranttypest =
    languagest == 'EN' ? 'Choose Restaurant Type' : "Restoran Türünü Seç";

String creatememest = languagest == 'EN' ? 'Create Meme' : "Meme Yarat";
String groceryshoppingst =
    languagest == 'EN' ? 'Grocery Shopping' : "Bakkal Alışverişi";
String whatdoyouwanttocreatest = languagest == 'EN'
    ? 'What do you want to create?'
    : 'Ne yapmak istiyorsunuz?';
String tutorialst = languagest == 'EN' ? 'Guide' : 'Rehber';
String datetimeforappnst =
    languagest == 'EN' ? 'Give Client Date and Time for Appointment' : 'Rehber';
String articlest = languagest == 'EN' ? 'Post' : 'Paylaşım';
String clickusertountag = languagest == 'EN'
    ? 'Click User to Untag'
    : 'Tagı kaldırmak için kullanıcıya tıklayın';
String chosencategoryst =
    languagest == 'EN' ? 'Chosen Catalogue' : 'Seçilen Katalog';
String movearticleinsideacategoryst = languagest == 'EN'
    ? 'Move Article Inside a Catalogue'
    : 'Makaleyi Kataloğa Yerleştir';
String searchtagsexclusivelyst =
    languagest == 'EN' ? 'Search with Tags Only' : "Sadece Taglar ile Ara";
...
String isdetailsprivatest =
    languagest == 'EN' ? 'Is Details Private' : "Detaylar kapalı olacak mı?";
String calendarsettingsst =
    languagest == 'EN' ? 'Calendar Settings' : "Takvim ayarları";
String sendfollowrequestst =
    languagest == 'EN' ? 'Send Follow Request' : "Takip isteği gönder";
...
String reservationdeactivateddaysst =
    languagest == 'EN' ? 'Reservation Deactivated Days' : "";
String calendardatewarningst = languagest == 'EN'
    ? 'IF YOU ARE GOİNG TO CREATE STATUS FOR MULTİPLE MONTHS,CREATE ONE MONTH THEN CREATE ANOTHER MONTH!'
    : "EĞER BİRDEN FAZLA AY İÇİN OLUŞTURACAKSANIZ,BİR AYI BİTİRİP SONRA TEKRARDAN GİRİP OLUŞTURUN!";
String calendarstatuswarningst = languagest == 'EN'
    ? 'Deleting them wont affect any schedule or requests'
    : "Saatleri silmenin randevu ve isteklere bir etkisi olmayacaktır";
String timeforcalendarst = languagest == 'EN'
    ? "Time (Ör: 15.30-16.30/All Day)"
    : "Saat (Ör: 15.30-16.30/Tüm Gün)";
String productst = languagest == 'EN' ? "Product" : "Ürün";
String reservationschedulesst =
    languagest == 'EN' ? "Reservation Schedules" : "";
String entercheckboxtextst =
    languagest == 'EN' ? "Enter Checkbox Text" : "Tik Kutusu yazısını girin";
String enterformtextst =
    languagest == 'EN' ? "Enter Form Text" : "Form Yazısını girin";
...
String termsandconditionsdetailsst = languagest == 'EN'
    ? '''Preview your Terms & Conditions
Terms and Conditions
Welcome to aio_ui App!

These terms and conditions outline the rules and regulations for the use of aio_ui's application, located at aio_ui Application.

By accessing this application we assume you accept these terms and conditions. Do not continue to use aio_ui App if you do not agree to take all of the terms and conditions stated on this page.
...
License
Unless otherwise stated, aio_ui and/or its licensors own the intellectual property rights for all material on aio_ui App. All intellectual property rights are reserved. You may access this from aio_ui App for your own personal use subjected to restrictions set in these terms and conditions.

You must not:

Republish material from aio_ui App
Sell, rent or sub-license material from aio_ui App
Reproduce, duplicate or copy material from aio_ui App
Redistribute content from aio_ui App
...
Parts of this application offer an opportunity for users to post and exchange opinions and information in certain areas of the application. aio_ui does not filter, edit, publish or review Comments prior to their presence on the application. Comments do not reflect the views and opinions of aio_ui,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, aio_ui shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this application.

aio_ui reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
...
You hereby grant aio_ui a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
...
We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of aio_ui; and (d) the link is in the context of general resource information.

These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.

If you are one of the organizations listed in paragraph 2 above and are interested in linking to our application, you must inform us by sending an e-mail to aio_ui. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our application, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
...
No use of aio_ui's logo or other artwork will be allowed for linking absent a trademark license agreement.
...
Şartlar ve koşullar
aio_ui Uygulamasına hoş geldiniz!

Bu hüküm ve koşullar, aio_ui Uygulamasında bulunan aio_ui uygulamasinin kullanımına ilişkin kural ve düzenlemeleri özetlemektedir.

Bu uygulamasine erişerek, bu hüküm ve koşulları kabul ettiğinizi varsayıyoruz. Bu sayfada belirtilen tüm hüküm ve koşulları kabul etmiyorsanız aio_ui Uygulamasını kullanmaya devam etmeyin.
...
Kurabiye
Çerez kullanımı kullanıyoruz. aio_ui Uygulamasına erişerek, aio_ui'nin Gizlilik Politikasına uygun olarak çerezleri kullanmayı kabul etmiş olursunuz.
...
Lisans
Aksi belirtilmedikçe, aio_ui ve/veya lisans verenleri, aio_ui Uygulamasındaki tüm materyallerin fikri mülkiyet haklarına sahiptir. Tüm fikri mülkiyet hakları saklıdır. Bu hüküm ve koşullarda belirlenen kısıtlamalara tabi olarak kendi kişisel kullanımınız için aio_ui Uygulamasından buna erişebilirsiniz.

Yapmamalısın:

aio_ui Uygulamasından materyali yeniden yayınlayın
aio_ui App'ten malzeme satmak, kiralamak veya alt lisans vermek
aio_ui Uygulamasından materyalleri çoğaltın, çoğaltın veya kopyalayın
İçeriği aio_ui Uygulamasından yeniden dağıtın
...
Bu uygulamasinin bölümleri, kullanıcılara uygulamasinin belirli alanlarında fikir ve bilgi gönderme ve alışverişinde bulunma fırsatı sunar. aio_ui, Yorumları uygulamasinde bulunmadan önce filtrelemez, düzenlemez, yayınlamaz veya incelemez. Yorumlar, aio_ui'nin, acentelerinin ve/veya bağlı kuruluşlarının görüş ve görüşlerini yansıtmaz. Yorumlar, görüş ve düşüncelerini yayınlayan kişinin görüş ve düşüncelerini yansıtır. Yürürlükteki yasaların izin verdiği ölçüde, aio_ui Yorumlardan veya bu Yorumların herhangi bir şekilde kullanılması ve/veya yayınlanması ve/veya görünümünden kaynaklanan ve/veya maruz kalınan herhangi bir yükümlülük, zarar veya masraftan sorumlu olmayacaktır. İnternet sitesi.

aio_ui, tüm Yorumları izleme ve uygunsuz, saldırgan olarak kabul edilebilecek veya bu Hüküm ve Koşulların ihlaline neden olabilecek Yorumları kaldırma hakkını saklı tutar.
...
Burada aio_ui'ye münhasır olmayan bir lisans veriyorsunuz, kullanmak, çoğaltmak, düzenlemek ve başkalarına herhangi bir şekilde, herhangi bir biçimde, formatta veya ortamda Yorumlarınızı kullanmak, çoğaltmak ve düzenlemek için yetki vermektesiniz.
...
Bir ticari marka lisans sözleşmesi olmadan bağlantı kurmak için aio_ui'nin logosunun veya diğer sanat eserlerinin kullanılmasına izin verilmeyecektir.
...
String isdeliveredst =
    languagest == 'EN' ? 'Is Product Delivered' : "Teslim Edilecek mi";
String allowstocksst = languagest == 'EN' ? 'Allow Stocks' : "Stoğa İzin Ver";
List<String> notificationchoices2 = <String>[
  allst,
  notificationst,
  orderst,
  requestst
];
List<String> pricerangechoices = <String>[
  premiumst,
  highst,
  standardst,
  lowst,
...
String userservices2st = languagest == 'EN'
    ? 'How user services work?'
    : 'Kullanıcı servisleri nasıl işler?';
String userservices3st = languagest == 'EN'
    ? 'How user service notifications work?'
    : 'Kullanıcı servis bildirimleri nasıl işler?';
String howsubusersworkst =
    languagest == 'EN' ? 'How subusers work?' : 'Altkullanıcılar nasıl işler?';
String whatissubusersst =
    languagest == 'EN' ? 'What is subuser?' : 'Altkullanıcı nedir?';
String howsearchworksst = languagest == 'EN'
    ? 'How search engine works?'
    : 'Arama motoru nasıl işler?';
String creatingcalendarforfullcalendarst = languagest == 'EN'
    ? 'Creating system for full calendar'
    : 'Tam takvim için sistemi oluşturma';
String notificationsforrequestsonlyst = languagest == 'EN'
    ? 'Notifications for requests only calendar'
    : 'Sadece istekler üzerine bir takvim için bildirimler';
String requestappointmentforfullcalendarst = languagest == 'EN'
    ? 'Creating appointment for full calendar'
    : 'Tam takvim için randevu istemek';
String requestappointmentforrequestsonlyst = languagest == 'EN'
    ? 'Creating appointment for requests only calendar'
    : 'Sadece istek takvimi için randevu yaratmak';
String tagusersst =
    languagest == 'EN' ? 'How to tag users?' : 'Kullanıcılar nasıl taglanır?';
String eventsonlycalendarst = languagest == 'EN'
    ? 'How events only calendar works?'
    : 'Sadece etkinlik içeren takvim nasıl işler?';
String iconsst = languagest == 'EN'
    ? 'What are icons at create screens?'
    : 'Öğe yaratma ekranındaki ikonlar nedir?';
String categoriesst = languagest == 'EN'
    ? 'What are user product/service categories?'
    : 'Kullanıcı ürün/servis kategorisi nedir?';
String taguserssst = languagest == 'EN' ? 'Tag users' : 'Kullanıcıları tagla';

String whatisuserproductst =
    languagest == 'EN' ? 'What is user product?' : 'Kullanıcı ürünleri nedir?';
String whatisuserservicest = languagest == 'EN'
    ? 'What is user service?'
    : 'Kullanıcı servisleri nedir?';
String whatiscalendarst =
    languagest == 'EN' ? 'What is calendar?' : 'Takvim nedir?';

String whatisuserproductexpst = languagest == 'EN'
    ? 'User Products allow you to show your inventory to your customers.For example you can post your 3 laptop types under Laptop categories'
    : 'Kullanıcı ürünleri sizin envanterinizi müşterilerinize göstermenizi sağlar.Örneğin 3 çeşit laptopunuzu laptop kategorisi altında yayınlayabilirsiniz.';
String whatisuserserviceexpst = languagest == 'EN'
    ? 'User Services allow you to create forms and allow you to collect some information from your customers (registration forms,etc..)'
    : 'Kullanıcı servisleri formlar yaratmanızı ve müşterilerinizden bilgi toplamanızı sağlar.';
